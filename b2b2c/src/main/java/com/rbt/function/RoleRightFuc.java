 ...
 * @author 创建人 林俊钦
 * @date 创建日期 Jul 7, 2011 3:14:31 PM
 */
public class RoleRightFuc extends CreateSpringContext {

	/**
	 * @MethodDescribe 方法描述 通过菜单ID查找关于该菜单所有的操作权限
	 * @author 创建人 林俊钦
	 * @date 创建日期 Jul 7, 2011 3:15:24 PM
	 */
	...
	public static String getMenuRightListByMenuid(String menu_id) {
		...
		if (list.size() < 0) {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				sb.append("<input type=\"checkbox\" name=\"role.oper_right\" value=\"" + right_id + "\" id=" + menu_attr + right_id + "/>");
