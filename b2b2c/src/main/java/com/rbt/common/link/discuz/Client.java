...
public class Client extends PHPFunctions{
	...
	//Discuz论坛服务器IP地址
	public static String cfg_discuz_ip=SysconfigFuc.getSysValue("cfg_discuz_ip");
	//Discuz论坛域名地址
	public static String cfg_discuz_url=SysconfigFuc.getSysValue("cfg_discuz_url");
	//Discuz论坛密钥
	public static String cfg_discuz_key=SysconfigFuc.getSysValue("cfg_discuz_key");
	//Discuz应用ID
	public static String cfg_discuz_pid=SysconfigFuc.getSysValue("cfg_discuz_pid");
	
	public static boolean IN_UC = true;
	public static String UC_IP = cfg_discuz_ip;//论坛IP地址
	public static String UC_API = cfg_discuz_url+"/uc_server";//论坛域名地址
	public static String UC_CONNECT = "";
	public static String UC_KEY =cfg_discuz_key;//论坛密钥和论坛配置的一致
	public static String UC_APPID = cfg_discuz_pid;//论坛应用ID
	public static String UC_CLIENT_VERSION = "X25";//版本号
	public static String UC_CLIENT_RELEASE = "20120810";
...
//		}
	...
	*/
	 ...
	 * @return int
		...
		-8 : 受保护的用户，没有权限修改
	*/
	public String uc_user_edit_password(String $username, String $oldpw, String $newpw) {
		Map<String,Object> args = new HashMap<String, Object>();		 
		args.put("username", $username);
		args.put("oldpw",$oldpw);
		args.put("newpw",$newpw);
