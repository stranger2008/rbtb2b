...
public class CodeEngine {
	...
	//数据库表名
	private static final String TABLENAME = "attrvalue";
	
	//表主键
	private static final String TABLEKEY = "trade_id";
	
	//功能名称
	private static final String FUNNAME = "记录分类属性的值";
	
	//功能名称
	private static final String AUTHOR = "林俊钦";
