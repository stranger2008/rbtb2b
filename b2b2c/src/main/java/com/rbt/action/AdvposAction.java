 ...
 * @author 创建人 邱景岩  
 * @date 创建日期 Jul 7, 2011 5:50:38 PM
 */         
@Controller
public class AdvposAction extends BaseAction implements Preparable{
	...
	/*
	 * 搜索字段 pos_name_s:广告位名称 pos_type_s:广告位类型 size_s:规格 module_type_s：所属模块
	 */
	public String pos_name_s;
	public String pos_type_s;
	public String pos_size_s;
	public String pos_price_s;
	public String isshow_s;
	public String pos_id_s;
	public String module_type_s;
	public String cat_attr_s;
	public String area_attr_s;
	public List commpara_modelList;
	//广告所属模块
	public String adv_pos_s;
	/*广告所属模块*/
	private String PARA_CODE="adv_pos";
	/*查找广告所属模块集合*/
	public List adv_posList ;
	
	/*
	 * 广告位批量更新隐藏字段 batch_update_hidden_posid
	 */
	public String batch_update_hidden_posid;
	/*
	 * 广告位Service业务层接口
	 */
	@Autowired
	...
	public String list() throws Exception {
		...
		advposList = CategoryFuc.replaceList(advposList,"module_type");
	...
	public String delete() throws Exception {
		this.advposService.delete(this.advpos.getPos_id());
		this.addActionMessage("删除广告位成功");
		return list();
	}
