...
public class AlipayConfig {
   ...
   public static String partner =PaymentFuc.getPayment("alipay").getPay_account();
	...
	public static String notify_url = "http://"+SysconfigFuc.getSysValue("cfg_basehost")+"/plugins/payment/alipay/notify_url.jsp";
	
	// 付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
	//return_url的域名不能写成http://localhost/js_jsp_utf8/return_url.jsp ，否则会导致return_url执行无效
	public static String return_url = "http://"+SysconfigFuc.getSysValue("cfg_basehost")+"/plugins/payment/alipay/return_url.jsp";
	
	// 网站商品的展示地址，不允许加?id=123这类自定义参数
	public static String show_url = SysconfigFuc.getSysValue("cfg_basehost");
	
	//收款方名称，如：公司名称、网站名称、收款人姓名等
	public static String mainname = SysconfigFuc.getSysValue("cfg_webname");
	//↑↑↑↑↑↑↑↑↑↑请在这里配置您的基本信息↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
