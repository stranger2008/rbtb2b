/////////////////////////加载简历//////////////////////////////
 $(document).ready(function(){
	    $.ajax({  	 
            type: "post",    	     
            url: "/portal/resume!getResumeInBoxs.action"+"&ajaxRequestRandom="+Math.random(),       
            datatype:"json",
            async:false,
...
////////////////////////申请职位////////////////////////////////////
 ...
 { 
      ...
      if(resumeid=="0")
      {
	     ...
	     $.ajax({  	 
            type: "post",    	     
            url: "/portal/resume!addResumeInBox.action?resumeid="+resumeid+"&companyid="+custid+"&jobid="+infoids+"&ajaxRequestRandom="+Math.random(),     
            datatype:"json",
            async:false,
            success: function(data){  
               ...
               else if(data=="2")
               {
                 alert("抱歉，您还没有填写简历或您的简历没办法使用，无法申请职位，请先填写简历或更新简历！");
                  document.location.href="/member_Resume_cate.action?loc="+urls;
               }
               else if(data=="3")
               {
