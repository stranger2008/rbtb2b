...
$(document).ready(function(){
    ...
    $.ajax({  	 
            type: "post",    	     
            url: "/portal/know!getallanswers.action?askid="+infoid+"&ajaxRequestRandom="+Math.random(),       
            datatype:"json",
            async:false,
...
/////////////////////////动态加载回答框开始///////////////////////////////////////
    $.ajax({  	 
            type: "post",    	     
            url: "/portal/know!getanswerstates.action?askid="+infoid+"&ajaxRequestRandom="+Math.random(),       
            datatype:"json",
            async:false,
            success: function(data){
 			...
 			if(data=="0")
 			{
    		    ...
    		    divanswerhtml+="<div class='wljd' ><div class='jd_t'></div><div class='jd_c'>";
   				divanswerhtml+="<p class='jd_title'><span class='jd_m'>我来帮他解答</span><span class='jd_sr'>还能输入<span><label id='countnum' style='color: red;font-weight: bold;'>2000</label></span>字</span></p>";
    			...
    			divanswerhtml+=" <div class='jd_m12'>验&nbsp;&nbsp;证&nbsp;码: <input type='text' maxlength='4' name='rand_s' id='rands' style='width:50px;' /> ";
 			...
 			else if(data=="1")
 			{
              ...
              $.ajax({  	 
                     type: "post",    	     
                     url: "/portal/know!getanswerbest.action?askid="+infoid+"&ajaxRequestRandom="+Math.random(),       
                     datatype:"json",
                     async:false,
                     success: function(data)
                     {
...
function addanswer()
 {
   ...
   var refdata=$("#refdata").val();
    $.ajax({  	 
            type: "post",    	     
            url: "/portal/know!verificationrandusername.action?askid="+askid+"&rand_s="+rads+"&ajaxRequestRandom="+Math.random(),       
            datatype:"json",
            async:false,
            success: function(data){
             if(data=="1")
