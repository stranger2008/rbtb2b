...
<%
  //文件选择器，主要用于栏目模板页的选择（页面模板、详细页模板）的选择模板
	String retStr = "";
	//项目路径
	String webpath = PropertiesUtil.getRootpath()+Constants.TEMPLATE_PORTAL_FOLDER+SysconfigFuc.getSysValue("cfg_templatefolder");
...
<head>
	...
	<style type="text/css">
 	...
 	#name_list ul{margin-left:15px; padding:0px; list-style-image:url(/include/images/admin/mfolder.gif);}
	#name_list ul li{ padding-left:5px; margin-top:0px;margin-bottom:5px;}
	#name_list ul li ul{margin-left:15px; padding:0px; list-style-image:url(/include/images/admin/mleaf.gif);}
		...
		<tr>
			<td>
				...
				%>
							...
							<img src="/include/images/admin/mfolder.gif" border="0">
							<%=files[i]%></a><br/>
				<% 
				...
				%>
							...
							<img src="/include/images/admin/mleaf.gif" border="0" >
							<%=files[i]%></a>
							<br/>
				<% 
						}
