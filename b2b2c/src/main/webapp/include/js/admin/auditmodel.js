	     ...
	     if(count>0){//如果已添加则提示信息,否则则添加成功
	        ...
	        if(add_mem_text!=""){
	             var strallapp="";	  
   		     	 ...
   		     	 +"<img title='向上排序' id='img_up_"+sel_count+"' class='img_up'  src='/include/images/admin/upmem.jpg' /></a>";
   		     	 ...
   		     	 +"<img title='向下排序' id='img_down_"+sel_count+"' class='img_down'  src='/include/images/admin/downmem.jpg' /></a>";
   		     	 ...
   		     	 +"<img title='删除' src='/include/images/admin/del_mem.jpg' /></a><input type='hidden' name='all_member_id_str' id='hidden_"+add_mem_text+"' value=\""+add_mem_id+"\"/></div>";
