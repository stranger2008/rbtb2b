...
<title>网站公告—${(memberconfig.web_title)?if_exists}</title>
...
<!--头部结束-->
<div class="position"><P><span class="f_left wz">当前位置: <a href="/showroom/${user_name?if_exists}" style="font-size:14px;">首页</a> > 网站公告 </span>  <span class="data f_right"> 今天是 ${systime?if_exists}</span></span></P></div>
 ...
 <div class="r_body f_right">
       <!--目录式浏览-->
        <div class="right_main">
           <div class="r_title"><h2><span class="title_font">网站公告</span></h2></div> 
            <div class="other_main">
               <div class="news_cont">
               <#if (memberconfig.site_notice)?if_exists==''>暂无数据</#if>
                ${(memberconfig.site_notice)?if_exists}
               </div>
           </div>
       </div>
    <!--目录式浏览-->
