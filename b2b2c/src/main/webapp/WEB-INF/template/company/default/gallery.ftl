...
<!--头部结束-->
<div class="position"><P><span class="f_left wz">当前位置: <a href="/showroom/${user_name?if_exists}" style="font-size:14px;">首页</a> > 公司相册 </span> <span class="data f_right">今天是 ${systime?if_exists}</span></span></P></div>
...
<div class="w960">
 ...
 <div class="r_body f_right">
       ...
       <div class="right_main">
            <div class="r_title">
              <h2><span class="title_font f_left">公司相册</span></h2>
            </div> 
            <div class="other_main">
               ...
               <div  class="divMiddle" style="width:156px;height:126px;line-height:126px;">
	               <a href="/showroom/${user_name?if_exists}/gallerypic/detail_${gallery.gal_id?if_exists}.html"  class="AMiddle"  style="width:156px;">               
	                  <img src="${gallery.img_path?if_exists}" width="146px" height="116px"
                         ${stack.findValue("@com.rbt.function.ChannelFuc@getSetImgSize('${(gallery.img_path)?if_exists}','146','116')")} class="ImgMiddle"/>
	               </a>
	           </div>	  

               <p style="margin-top:6px;"><a href="/showroom/${user_name?if_exists}/gallerypic/detail_${gallery.gal_id?if_exists}.html">
               <#if gallery.title?length lt 7>${gallery.title?if_exists}<#else>${gallery.title[0..6]}...</#if></a></p>
               </li> 
               </#list>
