<html>
  ...
  <body>
<div class="cont_main">
   	<@s.form action="/member_Download_update.action" method="post" validate="true" onsubmit="return showPicPath();">
   	    <table width="100%" class="cont_title">
 	<tr>
    	<td>当前位置:信息管理>下载管理>修改下载</td>
 	</tr>
	</table>
        <table width="100%" border="0" bgcolor="#DDDDDD" cellspacing="1" class="main_cont">
               ...
               <td>
                <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <@s.hidden name="download.cat_attr" />
              		<a href="/member_Download_cate.action?cat_attr=0&download.down_id=${download.down_id?if_exists}">[重新选择]</a>
	            <#else>
		            <table>
	             		<tr>
	             			<td class="tdbottom">
	       ...
	       <input type="button" name="returnList" class="sub" value="返回列表" onclick="linkToInfo('/member_Download_list.action','');"/>
           </td>
           </tr>
         </table>
	       <!--所属分类插件隐藏字段开始区域-->
