...
<body>
 ...
 <@s.form action="/member_Memberuser_updatepasswd.action" method="post" validate="true">
 <script src="/include/discuzlink/loginDiscuz.jsp"></script>
     <table width="100%" class="cont_title">
      <tr>
       <td>当前位置:会员信息>账号管理>设置用户密码</td>
      </tr>
    </table>
