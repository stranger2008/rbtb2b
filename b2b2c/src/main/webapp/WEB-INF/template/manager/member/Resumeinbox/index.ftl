...
<body>
<@s.form action="/member_Resumeinbox_list.action" method="post">
  <div class="cont_main">
  <table width="100%" class="cont_title">
 	<tr>
    	<td>当前位置:信息管理>招聘管理>简历收件箱</td>
 	</tr>
	</table>
    ...
    <td width="10%"  align="center" class="top_td">应聘会员</td>
  ...
  <tr bgcolor="#FFFFFF">
   ...
   已邀请
    ...
    <td align="center">
    <a onclick=linkToInfo("/member_Resumeinbox_view.action","resumeinbox.inbox_id=${sysresumein.inbox_id?if_exists}");>
