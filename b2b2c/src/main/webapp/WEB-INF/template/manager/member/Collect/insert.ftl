<html>
  ...
  <body>
<div class="cont_main">
   	<@s.form action="/member_Collect_inserts.action" method="post" validate="true">
 	<table width="100%" class="cont_title">
 	<tr>
    	<td>当前位置:商机管理>商机收藏>添加收藏</td>
 	</tr>
	</table>
        <table width="100%" border="0" bgcolor="#DDDDDD" cellspacing="1" class="main_cont">
           <tr>
             <td width="17%" valign="middle" class="left_td">标题名称<font color="red">*</font></td>
             <td>
             	<@s.textfield name="collect.title" cssClass="txtinput" maxLength="100" cssStyle="width:400px"/>
