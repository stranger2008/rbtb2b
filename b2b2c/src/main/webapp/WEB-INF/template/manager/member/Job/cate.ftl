<html>
  <head>
	...
	<script type="text/javascript">
	  $(document).ready(function(){ 
		 ...
		 is_supply_insert="supply";//用于添加招聘时的分类不能为空，才添加select的size属性	
		 //如果为添加招聘属性的分类时， 则要加上这个属性          
   	     $(".select").attr("size",2); 
   	     //提示信息
  ...
  <body >
<@s.form action="/member_Job_gopage.action"  method="post" validate="true"> 
   ...
   <table width="100%" class="cont_title">
	 ...
	 <div class="main_cont"  style="height:800px;">      
	   <table  width="100%">
          ...
          <input type="button"  value="重新选择" style="cursor:pointer;" onclick="linkToInfo('/member_Job_cate.action','');"/>           
          <#if job?if_exists!=''>     
