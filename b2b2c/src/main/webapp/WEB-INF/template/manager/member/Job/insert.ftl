...
<body>
 <div class="cont_main">
 <@s.form action="/member_Job_insert.action" method="post" validate="true">
    <table width="100%" class="cont_title">
 	<tr>
    	<td>当前位置:信息管理>招聘管理>添加招聘</td>
 	</tr>
	</table>
  ...
  <tr>
    ...
    <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <a href="/member_Job_cate.action?cat_attr=0">[重新选择]</a>
 ...
 <@s.textfield name="job.address" cssStyle="width:300px;"  cssClass="txtinput" maxLength="100"/>
  ...
  <tr>
    ...
    <td>
    <@s.radio name="job.is_where" cssClass="txtinput" list=r"#{'0':'国内招聘','1':'海外招聘'}" value="0"/> 
    </td>
  </tr>
    <tr>
    <td valign="middle" class="left_td" >是否委托:</td>
    <td>
    <@s.radio name="job.is_trust" cssClass="txtinput" list=r"#{'0':'否','1':'是'}" value="0"/> 
    </td>
  </tr>
  <tr>
