<html>
  ...
  <body >
<@s.form action="/member_Ask_gopage.action"  method="post" validate="true"> 

<div class="main_index f_left">
  <table width="100%" class="cont_title">
 	 <tr>
    	<td>当前位置:功能模块 > 知道管理 > 添加提问</td>
 	 </tr>
	 </table>
	 <div class="main_top">   
	 </div>	 
	 <div class="main_cont"  style="height:800px;">      
	   <table width="100%">
          ...
          <input type="button"  value="重新选择"style="cursor:pointer;" onclick="linkToInfo('/admin_Ask_cate.action','');"/>
          <#if ask?if_exists!=''>
