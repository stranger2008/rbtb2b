<html>
  ...
  <body >
<@s.form action="/member_Download_gopage.action"  method="post" validate="true"> 
   ...
   <table width="100%" class="cont_title">
	 ...
	 <div class="main_cont"  style="height:800px;">      
	   <table  width="100%">
          ...
          <input type="button"  value="重新选择" style="cursor:pointer;" onclick="linkToInfo('/member_Download_cate.action','');"/>           
