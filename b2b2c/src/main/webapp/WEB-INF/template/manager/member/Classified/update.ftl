<html>
  ...
  <body>
<div class="cont_main">
   	<@s.form action="/member_Classified_update.action" method="post" onsubmit="return showPicPath();" validate="true">
      <table width="100%" class="cont_title">
 	<tr>
    	<td>当前位置:信息管理>分类信息管理>修改分类信息</td>
 	</tr>
	</table>
        <table width="100%" border="0" bgcolor="#DDDDDD" cellspacing="1" class="main_cont">
          ...
          <tr>
               ...
               <td>
                <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <@s.hidden name="classified.cat_attr" />
              		 <a href="/member_Classified_cate.action?cat_attr=0&classified.info_id=${classified.info_id?if_exists}">[重新选择]</a>
	            <#else>
		            <table>
	             		<tr>
	             			<td class="tdbottom">
	       ...
	       <@s.hidden name="classified.info_state" value="0"/>
	        <#if sysmodule.is_catattr=="0">      
