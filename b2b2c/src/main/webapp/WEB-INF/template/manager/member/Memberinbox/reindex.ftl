...
<body>
<@s.form id="boxlist" action="/member_Memberinbox_reindex.action" method="post">
  <div class="cont_main">
  <table width="100%" class="cont_title">
      <tr>
       <td>当前位置:商机管理>我的信箱>回收站</td>
      </tr>
    </table>
    <div class="finder_bar_bg">
     <ul>
       <li><a onclick="showSearch(this,'searchDiv');">筛选</a></li>
       <li><a onclick="delInfo('memberinbox.info_id','/member_Memberinbox_reindex.action?trash=true')">删除</a></li>
       </ul>
    </div>
    ...
    <td width="20%" align="center" class="top_td">标题</td>
    <td width="20%" align="center" class="top_td">发件人名称</td>  
    <td width="20%" align="center" class="top_td">收件人名称</td>      
  ...
  <#list memberinboxList as memberinbox>
    ...
    <td align="center"><a onclick="linkToInfo('/member_Memberinbox_trashview.action','memberinbox.info_id=${memberinbox.info_id?if_exists}&type=3');">
    ...
    <td align="center">
      ${memberinbox.get_cust_id?if_exists}
    </td>
    <td align="center">
    ...
    <td align="center">
     <a onclick="linkToInfo('/member_Memberinbox_reindex.action','memberinbox.info_id=${memberinbox.info_id?if_exists}&trash=true');" class="dele">删除</a></td>
  </tr>
</#list> 
    </table>
...
<div class="divceng" style="display:none;" id="searchDiv">
	...
	<tr>
		...
		<td><@s.textfield name="send_name_s" maxLength="20"/></td>
	</tr>
	<tr>
		<td align="right">收件人名称:</td>
		<td><@s.textfield name="get_name_s" maxLength="20"/></td>
	</tr>
	<tr>
