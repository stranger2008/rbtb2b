...
<body>
 <div class="cont_main">
 <@s.form action="/member_Buy_update.action" method="post" validate="true">
     <table width="100%" class="cont_title">
 <tr>
    <td>当前位置:信息管理>商情管理>求购管理>修改求购</td>
 </tr>
</table>
  <table width="100%" border="0" bgcolor="#DDDDDD" cellspacing="1" class="main_cont">
     <#if buy.info_state?if_exists='2'> 
      <tr>
         <td width="17%" valign="middle" class="left_td" style="font-weight:bold;">未通过理由:</td>
        <td> ${buy.no_reason?if_exists}</td>
       </tr>
   </#if>
  <tr>
             <td valign="middle" class="left_td" width=120px;>求购标题<font color='red'>*</font></td>
             <td>
           ...
           <tr>
             <td valign="middle" class="left_td" >求购类型:</td>
             <td>
                <@s.radio name="buy.buy_type" list="commparalist" listKey='para_value'  listValue='para_key' check="true" />    
             ...
             <td>
                <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <@s.hidden name="buy.cat_attr" />
              		<a href="/member_Buy_cate.action?cat_attr=0&buy.buy_id=${buy.buy_id?if_exists}">[重新选择]</a>
	            <#else>
		            <table>
	             		<tr>
	             			<td class="tdbottom">
         ...
         <#if sysmodule.is_catattr=="0">      
          ...
          <tr>
             <td valign="middle" class="left_td">需求数量:</td>
             <td>
           ...
           <tr>
             <td valign="middle" class="left_td">价格要求:</td>
             <td>
           ...
           <tr>
             <td valign="middle" class="left_td" >规格要求:</td>
             <td>
          ...
          <tr>
             <td valign="middle" class="left_td" >包装要求:</td>
             <td>
           ...
           <tr>
             ...
             <#else>
             <@s.textfield cssClass="Wdate" value="${buy.end_date?if_exists[0..9]}"  name="buy.end_date" onfocus="WdatePicker({readOnly:true})" />         
             </#if>
            ...
            <tr  style="display:none;">
             ...
             <td>
         	 <@s.radio name="buy.is_recom" list=r"#{'0':'否','1':'是'}" checked="true" />      
         	   <@s.fielderror><@s.param>buy.is_recom</@s.param></@s.fielderror>  
             </td>
           </tr>
           <tr  style="display:none;">
             <td valign="middle" class="left_td">点击量<font color='red'>*</font></td>
             <td>
             	<@s.textfield  name="buy.clicknum" cssClass="txtinput" maxlength="11"/>
           ...
           <tr  style="display:none;">
             ...
             <td>
             	<@s.textfield  name="buy.fare" cssClass="txtinput" maxlength="11" />(只能输入数字,默认"0"则免费!)
  ...
  <tr>
    ...
    <@s.hidden name="token_value" value="${get_token_value?if_exists}"/>
	      ...
	      <!--所属分类插件隐藏字段开始区域-->
		   ...
		   <!--所属地区插件隐藏字段结束区域-->
	        <input type="button" name="returnList" value="返回列表" class="sub" onclick="linkToInfo('/member_Buy_list.action','');"/>
    </td>
  </tr>
</table>
