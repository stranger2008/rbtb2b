...
<body>
 <div class="cont_main">
 <@s.form action="/member_Memberuser_update.action" method="post" validate="true">
      <table width="100%" class="cont_title">
      <tr>
       <td>当前位置:会员信息>账号管理>修改账号</td>
      </tr>
    </table>
  <table width="100%" border="0" bgcolor="#DDDDDD" cellspacing="1" class="main_cont">
	    ...
	    <td colspan="4" class="subbut">
	      ...
	      <@s.hidden name="memberuser.user_type" />
