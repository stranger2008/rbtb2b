<html>
  ...
  <body>
<div class="cont_main">
   	<@s.form action="/member_Memberreport_insert.action" method="post" validate="true" onsubmit="return showPicPath();">
   	 <table width="100%" class="cont_title">
      <tr>
       <td>当前位置:会员信息>投诉举报>添加举报</td>
      </tr>
    </table>
        <table width="100%" border="0" bgcolor="#DDDDDD" cellspacing="1" class="main_cont">
           <tr>
             <td width="17%" valign="middle" class="left_td">举报地址<span class="mustfield">*</span></td>
              <td width="83%">
             	<@s.textfield name="memberreport.link_url" cssClass="txtinput" maxLength="200" cssStyle="width:400px;"/>例如:http://www.ruibaotong.com;
		  ...
		  <tr>
		    ...
		    <td>
		     <@s.select name="memberreport.report_type" list="CommparaList" listValue="para_key" listKey="para_value" headerKey="0" headerValue="请选择"/>
