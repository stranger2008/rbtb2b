...
<body>
 <div class="cont_main">
 <@s.form action="/member_Ask_insert.action" method="post" validate="true">
    <table width="100%" class="cont_title">
      <tr>
       <td>当前位置:信息管理>知道管理>提问管理>添加提问</td>
      </tr>
    </table>
...
<tr>
             ...
             ${sysmodule.is_catatrr}
                <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <a href="/member_Ask_cate.action?cat_attr=0">[重新选择]</a>
	            <#else>
		            <table>
	             		<tr>
	             			<td class="tdbottom">
	    ...
	    <td colspan="4" class="subbut">
	       ...
	       <@s.hidden name="ask.is_recom" value="0"/>
	       <@s.hidden name="ask.info_state" value="0"/>
	       <!--
	       		添加默认状态为：ask.answer_state 未解决
	       -->
	       <@s.hidden name="ask.answer_state" value="0"/>
	       <@s.hidden name="ask.fare" value="0"/>
	       <@s.hidden name="ask.clicknum" value="0"/>
