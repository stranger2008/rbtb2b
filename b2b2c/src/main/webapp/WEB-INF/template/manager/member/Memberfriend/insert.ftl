...
<title>会员添加商友</title>
	...
	<script type="text/javascript">
      ...
      function get_msg_by_name(){
 	       document.forms[0].action='/member_Memberfriend_showview.action?sg=1';
...
<body>
 <div class="cont_main">
 <@s.form action="/member_Memberfriend_insert.action" method="post" validate="true">
     <table width="100%" class="cont_title">
 	<tr>
    	<td>当前位置:商机信息>我的商友>添加商友</td>
 	</tr>
	</table>
  <table width="100%" border="0" bgcolor="#DDDDDD" cellspacing="1" class="main_cont">
         <tr>
             ...
             <td>
                <@s.select name="memberfriend.cat_id" list="membercat" listValue="cat_name" listKey="cat_id" headerKey="" headerValue="请选择"/>
          ...
          <tr>
             <td valign="middle" class="left_td">公司名<font color='red'>*</font></td>
             <td>          
