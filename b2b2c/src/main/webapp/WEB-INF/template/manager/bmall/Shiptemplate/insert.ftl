...
<@s.form id="shipfrom" action="/bmall_Shiptemplate_insert.action" method="post"  validate="true">
								    			...
								    			<#assign s_start=0/>
										    	  ...
										    	  <#if (sm.smode_id?if_exists==ship.c_mid?if_exists) && ship.d_ship=='0'>
									    	   		   <div class="defalut_mode">
											    			...
											    			<span>默认运费：<input  name='first_weight' type="text" style='width:60px;' value="${ship.f_weight?if_exists}"/> <font class='fd_unit'>件</font>内，</span>
											    			<span><input  name='first_price' type="text"  style='width:60px;'  value="${ship.f_price?if_exists}"/> 元，</span>
											    			<span>每增加<input name='cont_weight' type="text"  style='width:60px;'  value="${ship.c_weight?if_exists}"/> <font class='fd_price'>件</font>，</span>
 ...
 <!--获取系统的所有地区-->
		<div class='showareadiv1'>
			...
			<div class='areabottom'>
				...
				<@s.hidden id="sel_submit" value="3"/>
