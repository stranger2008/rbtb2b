...
<@s.form action="/bmall_Goods_update.action" method="post" validate="true" >
		...
		<table>
           <tr>
             ...
             <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <@s.hidden name="goods.cat_attr" />
              		<a href="/member_Goods_cate.action?cat_attr=0&goods.goods_id=${goods.goods_id?if_exists}">[重新选择]</a>
	            <#else>
		            <table>
	             		<tr>
	             			<td class="tdbottom">
		 ...
		 <tr>
	       ...
	       <tr>
	         ...
	         <td colspan="5">
	       	...
	       	<tr>
		             ...
		             <td colspan="5">
		             	<@s.textfield id="cp" name="goods.cost_price" cssClass="winput" maxLength="20" onkeyup="calculate(this.value);"  />
	       ...
	       <tr>
		             ...
		             <td colspan="3">
		             	<@s.textfield id="gmarket" name="goods.market_price" cssClass="winput" maxLength="20"  />
	                     	  ...
	                     	  <#else>
		                   	  ...
		                   	  <span style="margin-top:6px;">	
		                   		  <input type="hidden" name="memName" value="${mlevel.level_name?if_exists}"/>	                   	 	 	                   	     
		                   	  	 <input type="text" name="memPrice" style="width:122px;" value="${dislevel?if_exists}"  />
		                   	  </span>
		                   	  <br/>	
	   	   ...
	   	   <tr>
		         ...
		         <td  colspan="5">	             	
		           ...
		           <tr>
		             ...
		             <td colspan="5">
		             	<@s.textfield name="goods.total_stock" cssClass="winput" maxLength="20" />
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="goods.now_stock" cssClass="winput" maxLength="20" />
		             ...
		             <td colspan="3">
		             	<@s.textfield name="goods.warn_stock" cssClass="winput" maxLength="20" />
		           ...
		           <tr>
		             ...
		             <td colspan="5">
		             	<@s.textfield name="goods.saled_num" cssClass="winput" maxLength="20" />
       ...
       <div class="table_infor">
          <table >                 
           ...
           <tr>
             ...
             <td>
             	<@s.textfield name="goods.give_inter" cssClass="winput" maxLength="20" />
	           ...
	           <tr>
	             ...
	             <td>
	             	<@s.textfield name="goods.interbuy" cssClass="winput" maxLength="20"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textfield name="goods.weight"  cssClass="winput" maxLength="20"/>(kg)
		           ...
		           <tr>
		             <td colspan="2" align="center">
		      	       <#if sysmodule.is_catattr=="0">      
			           		...
			           		<input type="button" value="保存" class='submitbut' onclick="dosubmit();">
			           <#else>
			           		<@s.submit value="保存" cssClass="submitbut"/>
			           </#if>
