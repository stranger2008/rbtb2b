<html>
  <head>
    ...
    <script type="text/javascript"> 
	  $(document).ready(function(){ 
		 ...
		 var list= $('input:radio[name="groupgoods.is_seven"]:checked').val();
	     if(list==undefined){
	         $("input[name=groupgoods.is_seven]:eq(1)").attr("checked",'checked'); 
	     }	 
	     
	     var list1= $('input:radio[name="groupgoods.is_overdue"]:checked').val();
	     if(list1==undefined){
	         $("input[name=groupgoods.is_overdue]:eq(1)").attr("checked",'checked'); 
	     }
	     
	     var list2= $('input:radio[name="groupgoods.is_ship"]:checked').val();
	     if(list2==undefined){
	         $("input[name=groupgoods.is_ship]:eq(1)").attr("checked",'checked'); 
	     }
	     
	     var list3= $("#sortno").val();
	     if(list3==''){
	         $("#sortno").val(0); 
	     }
	     
	     var list4= $("#maxbuy").val();
	     if(list4==''){
	         $("#maxbuy").val(0); 
	     }
  ...
  <body>
	<div class="postion">
  		 <a href="#">我是卖家</a><span>></span><a href="#">促销管理</a><span>></span><a href="#">新增团购</a>
    </div>
<@s.form action="/bmall_Groupgoods_insert.action" method="post" validate="true" >
<div class="rightside f_right">
    <div class="rpostion"><h2>添加团购商品</h2></div>
    <div class="base_infor">
		<div class="table_infor f_left" >
        <table>
       		   <script type="text/javascript">
					function select_group(){
						window.open("/bmall_Goods_grouplist.action?ajaxRequestRandom="+Math.random());
					}	
		           ...
		           <tr>
		             ...
		             <td>
		             	...
		             	<input type="button" value="搜索商品"  class="submitbut" onclick="select_group();"/><br/>
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield id="maxbuy" name="groupgoods.cust_maxbuy" cssClass="winput" onkeyup="checkNum(this);"/>
		           ...
		           <tr>
		             <td class="firsttd">最低团购量<font color='red'>*</font></td>
		             <td>
		           ...
		           <tr>
		             <td class="firsttd">最高团购量<font color='red'>*</font></td>
		             <td>
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="groupgoods.reach_time" cssClass="Wdate" cssStyle="width:182px;" onfocus="WdatePicker({readOnly:true})"/>
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield id="txtstartDate" name="groupgoods.start_date"  type="text" cssStyle="width:180px;" 
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield id="txtendDate" name="groupgoods.end_date" cssStyle="width:180px;"  type="text" 
		           ...
		           <tr>
		             ...
		             <td>
		             	<div style="width:630px;">		             
			             	<@s.textarea name="groupgoods.group_desc" id="content"  cssClass="winput" />
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield id="sortno" name="groupgoods.sort_no" cssClass="winput" onkeyup="checkNum(this);" />
