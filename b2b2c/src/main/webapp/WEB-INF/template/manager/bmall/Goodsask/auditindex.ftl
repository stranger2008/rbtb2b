...
<body>
	<div class="postion">
 		<a href="#">我是买家</a><span>></span><a href="#">我的交易</a><span>></span><a href="#">我的咨询</a>
	</div>
<@s.form action="/bmall_Goodsask_auditList.action" method="post">
     ...
     <div class="ropot">
       ...
       <table cellspacing="0" class="bmall_list_table">
	     ...
	     <td class="fthstyle1" width="15%">咨询商品</td>
     	 <td class="fthstyle1" width="10%">咨询类型</td>
