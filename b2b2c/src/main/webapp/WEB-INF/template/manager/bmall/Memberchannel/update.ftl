...
<body>
	<div class="postion">
  		 </span><a href="#">我是卖家</a><span>></span><a href="#">店铺管理</a><span>></span><a href="#">店铺栏目管理</a><span>></span><a href="#">修改栏目</a>
    </div>
<@s.form action="/bmall_Memberchannel_update.action" method="post"  validate="true">
<@s.hidden name="mall_type" value="b2c"/>
<div class="rightside f_right">
     <div class="rpostion"><h2>修改栏目</h2></div>
           ...
           <tr>
				<td colspan="2" align="center">
					<@s.submit value="提  交" cssClass="submitbut"/>
             		...
             		<@s.hidden name="memberchannel.plat_type" value="b2c"/>
             	</td>
            </tr> 
          </table>
       </div>  
