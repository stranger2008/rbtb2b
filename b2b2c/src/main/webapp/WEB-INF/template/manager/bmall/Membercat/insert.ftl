...
<body>
	<div class="postion">
  		  <a href="#">我是卖家</a><span>></span><a href="#">商品管理</a><span>></span><a href="#">添加商品分类</a>
    </div>
     <#assign cat_level=0/>
	 <#if (membercat.cat_level)?if_exists ==''>
	 	<#assign cat_level = 1 />
	 <#else>
	 	<#assign cat_level = (membercat.cat_level?number+1) />
	 </#if>
<@s.form action="/bmall_Membercat_insert.action"  method="post"  validate="true">
 
<div class="rightside f_right">
     <div class="rpostion"><h2>商品分类管理</h2></div>
     <div class="base_infor">
       <h2 class="base_title">添加商品分类</h2>
       <div class="table_infor f_left">
          <table style="width:750px;" >
           ...
           <@s.radio name="membercat.is_recom" list=r"#{'0':'否','1':'是'}" value="0"  />  
        	<@s.fielderror><@s.param>membercat.is_recom</@s.param></@s.fielderror>
            </td></tr> 
            
             <tr><td  class="firsttd">排序:</td><td>
        	<@s.textfield name="membercat.sort_no" cssClass="txtinput"  cssStyle="width:80px;"   value="0"  onkeyup="checkNum(this);"/>*(只能输入数字)
...
<@s.hidden name="membertype"  value="3"   />
  <@s.hidden name="membercat.up_cat_id" value="${(membercat.up_cat_id)!'1111111111'}" />
    <@s.hidden name="membercat.cat_level" value="${cat_level}" />
 </@s.form>
