...
<body>
	<div class="postion">
  		 <a href="#">我是卖家</a><span>></span><a href="#">促销管理</a><span>></span><a href="#">优惠券管理</a><span>></span><a href="#">修改优惠券</a>
    </div>
<@s.form action="/bmall_Coupon_update.action"  method="post"  name="formshopcongif" validate="true">
<div class="rightside f_right">
     <div class="rpostion"><h2>促销管理</h2></div>
     <div class="base_infor">
       <h2 class="base_title">优惠券修改</h2>
              ...
              <tr>
	             ...
	             <td>
		           ...
		           <tr>
		             ...
		             <td>
		                <@s.radio name="coupon.c_type" list=r"#{'0':'优惠金额','1':'优惠积分','2':'优惠折扣'}" />
		           ...
		           <tr id="jifen" style="display:none" >
		             ...
		             <td>
		             	<@s.textfield name="coupon.c_inter" cssStyle="width:100px" cssClass="txtinput" maxLength="20"/>
		           ...
		           <tr id="jiner" style="display:none">
		             ...
		             <td>
		             	<@s.textfield name="coupon.c_money" cssStyle="width:100px" cssClass="txtinput" maxLength="20"/>
		           ...
		           <tr id="zhekou" style="display:none">
		             ...
		             <td>
		             	<@s.textfield name="coupon.c_discount" cssStyle="width:100px" cssClass="txtinput" maxLength="20"/>
		             	(折扣数1-100)
			       ...
			       <tr>
				    <td class="firsttd">有效时间<font color='red'>*</font></td>
		             <td colspan="3">
			                <#if coupon.start_time?if_exists?length lt 10>
			              <@s.textfield id="txtstartDate" name="coupon.start_time"  type="text" cssStyle="width:100px;" cssClass="Wdate" 
					               readonly="true" onclick="WdatePicker({maxDate:'#F{$dp.$D(\\'txtendDate\\',{d:1})}',readOnly:true})"  /> 
			             <#else>
			             <@s.textfield id="txtstartDate" name="coupon.start_time"  type="text" cssStyle="width:100px;" cssClass="Wdate" 
					               readonly="true" onclick="WdatePicker({maxDate:'#F{$dp.$D(\\'txtendDate\\',{d:1})}',readOnly:true})"
					               value="${coupon.start_time?if_exists[0..9]}"  />          
			             </#if>至
			               <#if coupon.end_time?if_exists?length lt 10>
			               <@s.textfield id="txtendDate" name="coupon.end_time" cssStyle="width:100px;"  type="text" cssClass="Wdate" 
					               readonly="true" onclick="WdatePicker({minDate:'#F{$dp.$D(\\'txtstartDate\\',{d:1})}',readOnly:true})"  />
			             <#else>
			             <@s.textfield id="txtendDate" name="coupon.end_time" cssStyle="width:100px;"  type="text" cssClass="Wdate" 
					               readonly="true" onclick="WdatePicker({minDate:'#F{$dp.$D(\\'txtstartDate\\',{d:1})}',readOnly:true})" 
					               value="${coupon.end_time?if_exists[0..9]}" />         
			             </#if>
		           ...
		           <tr>
		             ...
		             <td>
		                <@s.radio name="coupon.is_every" list=r"#{'0':'是','1':'否'}"/>
