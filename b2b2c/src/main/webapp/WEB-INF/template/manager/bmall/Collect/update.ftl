...
<body>
	<div class="postion">
  		 <a href="#">我是买家</a><span>></span><a href="#">我的交易</a><span>></span><a href="#">我的收藏</a><span>></span><a href="#">我的收藏修改</a>
    </div>
     ...
     <div class="base_infor">
       ...
       <div class="table_infor f_left">
          <table style="width:750px;" >
        	...
        	<@s.radio name="collect.cat_id" list=r"#{'0':'商品','1':'店铺'}" />  
