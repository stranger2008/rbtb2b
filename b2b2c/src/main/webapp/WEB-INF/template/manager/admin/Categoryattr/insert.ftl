...
<div class="tj_main f_left">
   ...
   <div class="tj_main_cont">
   	<@s.form id="categoryattradd" action="/admin_Categoryattr_insert.action" method="post" validate="true">
        <table class="wwtable" cellspacing="1" cellpadding="8">
           ...
           <tr>
             ...
             <td>
             	<@s.textarea name="default_val" cssClass="mailCss"  onkeyup="set_textarea_length(this,600);" cssStyle="height:80px;width:420px;"/>（如果是复选框，有多个备选值，请以|线隔开）        
             </td>
           </tr>
         </table>
