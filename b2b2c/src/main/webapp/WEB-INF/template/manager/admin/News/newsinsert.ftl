...
<div class="tj_main f_left">
 <div class="pageLocation">
 	当前位置:功能模块 > ${mold?if_exists}公告管理 > 添加${mold?if_exists}公告
   </div>
   <div class="tj_main_cont">
   	<@s.form action="/admin_News_inseretnotice.action?news_mold=${news_mold?if_exists}" method="post" validate="true">
        <table class="wwtable" cellspacing="1" cellpadding="8">
	     ...
	     <div class="buttom">
	     <@s.hidden name="news.description" value="${mold?if_exists}公告"/>
	     <@s.hidden name="news.clicknum" value="0"/>
	     <@s.hidden name="news.fare" value="0"/>
	     <@s.hidden name="news.comment"  value="1"/>
	     <@s.hidden name="news.news_type" value="${news_mold?if_exists}"/>
	     <@s.hidden name="news.news_attr" value=""/>
