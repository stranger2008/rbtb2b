<html>
  <head>
	...
	<script type="text/javascript">
	      function showPicPath1(name){
	      	 document.getElementById('header_path').value = frame1.window.uploadfile();
	      	 showpicture(name);
	      }
    </script>
    <script type="text/javascript">
...
<div class="tj_main f_left">
 <div class="pageLocation">
 	当前位置:功能模块 > 专题管理 > 专题列表 > 修改专题
   </div>
   <div class="tj_main_cont">   
   	<@s.form action="/admin_Subject_update.action" method="post" validate="true">
   	    <input type="hidden" id="linkcats"  name="subject.link_cat"  value="${(subject.link_cat)?if_exists}"/>
   	    <input type="hidden" id="newsids"  name="subject.news_attr" value="${(subject.news_attr)?if_exists}" />
     	<input type="hidden" id="newstitles" />
     	<input type="hidden" id="newspicids" name="subject.img_news_attr" value="${(subject.img_news_attr)?if_exists}"  />
     	<input type="hidden" id="newspictitles" />
        <table class="wwtable" cellspacing="1" cellpadding="8">
               ...
               <td>
                <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <@s.hidden name="subject.cat_attr" />
              		<a href="/admin_Subject_cate.action?cat_attr=0&Subject.sub_id=${Subject.sub_id?if_exists}">[重新选择]</a>
          ...
          <tr>
            ...
            <tr>
             ...
             <td>
             	<@s.radio name="subject.is_comment" list=r"#{'0':'是','1':'否'}" />
            ...
            <tr>
             ...
             <td>
             	<@s.textfield name="subject.temp_path" cssClass="txtinput" maxLength="100"/>
            ...
            <tr>
             ...
             <td>
                <@s.radio name="subject.is_recom" list=r"#{'0':'否','1':'是'}" />
            ...
            <tr>
             ...
             <td>
             	<@s.radio name="subject.info_state" list=r"#{'0':'未审核','1':'正常','2':'未通过','3':'禁用'}" />
            ...
            <tr>
             ...
             <td>
             	<@s.textfield name="subject.clicknum" cssClass="txtinput" onkeyup="checkNum(this);" maxLength="11" onkeyup="checkNum(this);" onblur="checkEmpty(this);"/>
            ...
            <tr>
             ...
             <td>
             	<@s.textfield name="subject.fare" cssClass="txtinput" onkeyup="checkNum(this);"  maxLength="11" onkeyup="checkNum(this);" onblur="checkEmpty(this);"/>
