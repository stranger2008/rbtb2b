...
<div class="tj_main f_left">
   <div class="pageLocation">
 	当前位置:会员管理 > 企业会员 > 域名绑定申请>添加域名信息
   </div>
   <div class="tj_main_cont">
   	<@s.form action="/admin_Topdomain_insert.action" method="post" validate="true" >
        <table class="wwtable" cellspacing="1" cellpadding="8">
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="topdomain.cust_id" cssClass="txtinput" cssStyle="width:80px"  maxLength="9"  onkeyup="checkNum(this);" value="0"  />
		         ...
		         <tr>
		             ...
		             <td>
		             	 <@s.radio name="topdomain.domain_type" list=r"#{'0':'一级域名','1':'二级域名'}" value="0" />     	
		             ...
		             <td>
		             	 <@s.radio name="topdomain.enabled" list=r"#{'0':'否','1':'是'}" value="1" />     	
