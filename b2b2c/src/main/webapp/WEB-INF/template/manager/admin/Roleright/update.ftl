...
<div class="tj_main f_left">
 <div class="pageLocation">
   ...
   <div class="tj_main_cont">
   	...
   	<@s.form action="/admin_Roleright_update.action" method="post" validate="true">
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">
           ...
           <tr>
             ...
             <td>
             	<@s.select name="roleright.syscode" list=r"#{'sys':'管理员后台','com':'会员后台'}" onchange="selectSyscode(this.value);"/>
           ...
           <tr id="adminmenu" style="display:<#if roleright.syscode=='sys'><#else>none</#if>">
            ...
            <tr id="membermenu" style="display:<#if roleright.syscode=='com'><#else>none</#if>">
             <td class="table_name">所属菜单<font color='red'>*</font></td>
             <td>
             <script type="text/javascript">
        	  d = new dTree('d');
