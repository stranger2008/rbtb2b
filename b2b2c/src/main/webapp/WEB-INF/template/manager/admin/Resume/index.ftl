...
<@s.form action="/admin_Resume_list.action" method="post">
<@s.hidden name="resume.is_recom" id="admin_resume_state"/>
<div class="main_index f_left">
 ...
 <div class="main_top">
   <ul class="main_top_ul">
     <li class="tj">
     <a onclick="linkToInfo('/admin_Resume_cate.action','');">添加简历</a></li>
     
     <li class="sc"><a onclick="delInfo('resume.resume_id','/admin_Resume_delete.action')">删除</a></li>
     <li class="shuaix"><a onclick="showSearch(this,'searchDiv');">筛选</a></li>
     <li class="qiyong"><a onclick="updateRecomState('1','resume.resume_id','/admin_Resume_updateisrecom.action','admin_resume_state');">推荐</a></li>
     <li class="jingyong"><a onclick="updateRecomState('0','resume.resume_id','/admin_Resume_updateisrecom.action','admin_resume_state');">取消推荐</a></li>
   </ul>
 </div>
 <div class="main_cont">
  ...
  <#list resumeList as sysresume>
    ...
    <a onclick=linkToInfo("/admin_Resume_view.action","resume.resume_id=${sysresume.resume_id?if_exists}");>
   ...
   <#else>
    ...
    <td align="center">
    <a href="/admin_Member_viewinfo.action?member.cust_id=${(sysresume.cust_id)?if_exists}" target="_blank">
    ...
    <td align="center" >
         <a onclick="linkToInfo('/admin_Resume_list.action','cat_attr_s=${sysresume.cat_attr_id?if_exists}');">${sysresume.cat_attr?if_exists}</a>
    </td>
    <td align="center" >${sysresume.area_attr?if_exists}</td>
   <td align="center" >
    <#if sysresume.info_state?if_exists='1'>
   <a href="/admin_Resume_list.action?job_state_s=1" >
   <span class="greencolor">正常</span>
   </a>
   <#elseif sysresume.info_state?if_exists='3'>
   <a href="/admin_Resume_list.action?job_state_s=3" >
   <span class="redcolor">禁用</span>
   </a>
   <#elseif sysresume.info_state?if_exists='0'>
   <a href="/admin_Resume_list.action?job_state_s=0" >
   <span class="redcolor">未审核</span>
   </a>
   <#elseif sysresume.info_state?if_exists='2'>
   <a href="/admin_Resume_list.action?job_state_s=2" >
   <span class="bluecolor">未通过</span>
   </a>
   </#if>
   </td>
    <td align="center" >${sysresume.in_date?if_exists}</td >
    <td align="center"><a onclick=linkToInfo("/admin_Resume_view.action","resume.resume_id=${sysresume.resume_id?if_exists}");><img src="/include/images/bj.gif" /></a></td>
  </tr>
...
<div class="divceng" style="display:none;" id="searchDiv">
	...
	<tr>
		...
		<td><@s.select name="job_state_s" cssStyle="width:100px;" list=r"#{'请选择':'请选择','1':'正常','3':'禁用'}"  />
		</td>
	</tr>
	<tr>
