<html>
 ...
 <body>
<@s.form action="/admin_Supply_list.action" method="post">
<@s.hidden name="supply.is_recom" id="admin_supply_state"/>
<div class="main_index f_left">
 ...
 <div class="main_top">
   <ul class="main_top_ul">
     <li class="tj"><a onclick="linkToInfo('/admin_Supply_cate.action','');">添加供应</a></li>
     
     <li class="shuaix"><a onclick="showSearch(this,'searchDiv');">筛选</a></li>
     <li class="sc"><a onclick="delInfo('supply.supply_id','/admin_Supply_delete.action')">删除</a></li>
     <li class="qiyong"><a onclick="updateRecomState('1','supply.supply_id','/admin_Supply_updateisrecom.action','admin_supply_state');">推荐</a></li>
     <li class="jingyong"><a onclick="updateRecomState('0','supply.supply_id','/admin_Supply_updateisrecom.action','admin_supply_state');">取消推荐</a></li>
   </ul>
 </div>
 <div class="main_cont">
  ...
  <tr style="background:url(images/top_tr.gif) repeat-x;">
    ...
    <td width="8%" align="center" class="top_td">修改</td>
  </tr>
  <#list supplyList as supply>
    ...
    <#if supply.title?if_exists!=''>
		<a onclick="linkToInfo('/admin_Supply_view.action','supply.supply_id=${supply.supply_id?if_exists}');">
		    <#if supply.title?length lt 20>
	    ...
	    <a onclick="linkToInfo('/admin_Supply_list.action','is_recom_s=${supply.is_recom?if_exists}');">
	     	<font class="redcolor">[推荐]</a></font>
	    </#if>
    </#if>
    </td>
    <td align="center"> 
    <a href="/admin_Member_viewinfo.action?member.cust_id=${(supply.cust_id)?if_exists}" target="_blank"> 
      ${supply.cust_name?if_exists}
    </a>
    </td>
    <td align="center">
    <a onclick="linkToInfo('/admin_Supply_list.action','type_s=${supply.supply_type?if_exists}');">${supply.model_value?if_exists}</a></td>
    <td align="center">
    ...
    <td align="center">
    <a onclick="linkToInfo('/admin_Supply_list.action','state_s=${supply.info_state?if_exists}');">
    ...
    <td align="center"><a onclick="linkToInfo('/admin_Supply_view.action','supply.supply_id=${supply.supply_id?if_exists}');"><img src="/include/images/bj.gif" /></a></td>
  </tr>
</#list> 
</table>
 </div>
...
<div class="divceng" style="display:none;" id="searchDiv">
	...
	<tr>
		...
		<td>
		    <@s.select name="is_recom_s" list=r"#{'':'请选择','0':'不推荐','1':'推荐'}"/>
		</td>
	</tr>
	 <tr>
    <td align="right">搜索状态:</td>
	<td>
		    <@s.select name="state_s" list=r"#{'':'请选择','1':'正常','3':'禁用'}" />
		</td>
	</tr>
	<tr>
