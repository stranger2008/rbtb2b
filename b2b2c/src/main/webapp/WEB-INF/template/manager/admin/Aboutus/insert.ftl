...
<div class="tj_main f_left">
   ...
   <div class="tj_main_cont">
   	<@s.form action="/admin_Aboutus_insert.action" method="post" validate="true">
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">
           ...
           <tr>
             ...
             <a href="<#if mall_type?if_exists=='b2b'>/admin_Commpara_list.action?para_code_s=ch_id<#elseif (mall_type?if_exists)=='b2c'>/admin_Commpara_list.action?para_code_s=help_type</#if>" target="_blank">
             [栏目管理]</a>
