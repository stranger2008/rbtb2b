...
<div class="tj_main f_left">
 ...
 <@s.form action="/admin_Memberreport_update.action" method="post" validate="true" onsubmit="return noresult('memberreport.info_state','noreasonvalue','3');">
 <table class="wwtable" cellspacing="1" cellpadding="8">
		...
		for(var i in imgList1){
           ...
           <tr  id="reasonid" style="display:<#if noReasonKey?if_exists=='3'><#else>none</#if>">
		    ...
		    <td>
		        <@s.textarea name="memberreport.doresult" id="desc" cssClass="txtinput" id="noreasonvalue" cssStyle="width:500px;height:100px"  onkeyup="set_textarea_length(this,300);"/>
