...
<@s.hidden name="indexrecord.is_recom" id="admin_indexrecord_state"/>
<div class="main_index f_left">
 ...
 <div class="main_cont">
  ...
  <tr>
    ...
    <td align="center"><a onclick="linkToInfo('/admin_Indexrecord_view.action','indexrecord.trade_id=${indexrecord.trade_id?if_exists}');"><img src="/include/images/bj.gif" /></a></td>
  </tr>
  </#list>
</table>
 </div>
