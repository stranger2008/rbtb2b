...
<div class="f_left" style='width:80%;padding-top:3px;'>
    <div class="rpostion"><span style="font-weight:600;font-size:16px;margin:3px 0px 0px 6px;">订单信息</span></div>
	<div>
		<table width='100%'>
		    ...
		    <tr><td colspan='2'>
						 <div class="saletitle1" >
						   ...
						   <td style="padding-left:60px;">
						   		<table width="100%">
						   			<tr>
							   			<td width='39%'><span>店铺名称:</span>${saleMember.cust_name?if_exists}</td>
							   			<td  width='32%'><span>真实姓名:</span>${saleMember.contact_name?if_exists}</td>
							   			<td><span>所在城市:</span>${area_name?if_exists}</td>
						   			</tr>
						   			<tr>
			   ...
			   <td style="padding-left:60px;">
			   		<table width="100%" border='0'>
			   			<tr>
				   			...
				   			<td  width='32%'><span>支付方式:</span>${goodsorder.order_time?if_exists} </td>
...
<@s.form id="upsubmit" action='/admin_Goodsorder_upPrice.action'>
...
<@s.hidden name="up_insured"  id='hd_up_insured'/>
	...
	<div class="clear"></div>
	<div class='return'>
		<div class='operorderstate buttom'>
		<#if goodsorder.order_state=='2' || goodsorder.order_state=='3'>	
			    <@s.form action='/admin_Goodsorder_subOrder.action'>
					<@s.hidden name="oid"/>
		...
		<#if goodsorder.order_state=='0' && goodsorder.pay_state=='0'&& goodsorder.send_state=='0'>	
				...
				<@s.form action='/admin_Goodsorder_subPay.action'>
					<@s.hidden name="oid"/>
					<@s.hidden name="order_order_state" value="1"/>
		...
		<#if goodsorder.order_state=='1' && goodsorder.pay_state=='1'&& goodsorder.send_state=='0'>	
				<@s.form action='/admin_Goodsorder_subPay.action'>
					...
					<@s.submit value="设为未付款" cssClass="submitbut"/>
					<@s.hidden name="token_value" value="${get_token_value?if_exists}"/>   
				</@s.form> 	
				<@s.form action='/admin_Goodsorder_subPay.action'>
					<@s.hidden name="oid"/>
				...
				<@s.form action='/admin_Goodsorder_subSend.action'>
					<@s.hidden name="oid"/>
		...
		<@s.form action='/admin_Goodsorder_manaorder.action'>
