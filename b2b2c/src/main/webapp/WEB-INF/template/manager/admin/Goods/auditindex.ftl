<html>
  ...
  <body>
<@s.form action="/admin_Goods_auditList.action" method="post">
...
<div class="main_index f_left">
 ...
 <div class="main_cont">
  ...
  <tr>
    ...
    <td align="center"><a onclick="linkToInfo('/admin_Goods_audit.action','goods.goods_id=${goods.goods_id?if_exists}');"><img src="/include/images/audit.png" /></a></td>
  </tr>
  </#list>
</table>
 </div>
