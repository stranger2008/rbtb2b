...
<div class="tj_main f_left">
   ...
   <div class="tj_main_cont">
   	<@s.form action="/admin_Download_insert.action" method="post" validate="true" onsubmit="return showPicPath();">
        <table class="wwtable" cellspacing="1" cellpadding="8">
           ...
           <tr>
             ...
             <tr>
             <td class="table_name">下载说明<font color='red'>*</font></td>
             <td>
           ...
           <tr>
             ...
             <td>
             	<@s.radio name="download.is_recom" list=r"#{'0':'否','1':'是'}" value="0"/>
             </td>
           </tr>
            <tr>
             <td class="table_name">内容收费:</td>
             <td>
             	<@s.textfield name="download.fare" value="0" cssClass="txtinput" onkeyup="checkNum(this);" style="width:80px;" maxLength="10"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textfield name="download.clicknum" value="0" cssClass="txtinput" onkeyup="checkNum(this);" style="width:80px;" maxLength="10"/>
             ...
             <td>
             	<@s.textfield name="download.down_num" value="0" cssClass="txtinput" onkeyup="checkNum(this);" style="width:80px;" maxLength="10"/>
	     ...
	     <div class="buttom">
	       ...
	       <@s.hidden name="download.info_state" value="1"/>
           <#if sysmodule.is_catattr=="0">      
