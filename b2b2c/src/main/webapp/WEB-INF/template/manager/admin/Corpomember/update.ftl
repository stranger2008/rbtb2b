...
<div class="tj_main f_left">
 <div class="pageLocation">
 	   当前位置:会员管理 > 企业会员 > 修改企业会员
 </div>
   <div class="tj_main_cont">
   	<@s.form id="com_insert" action="/admin_Corpomember_update.action" method="post" validate="true">
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">
           ...
           <tr>
             <td class="table_name">企业名称<font color='red'> *</font></td>
             <td colspan="3">
           ...
           <tr>
             <td class="table_name">企业状态:</font></td>
             <td colspan="3">
             	<@s.radio name="member.info_state" list=r"#{'1':'审核通过','3':'禁用'}"/>
            ...
            <tr>
             ...
             <td>
             	<@s.textfield name="member.contact_name" cssClass="txtinput"  maxLength="50" cssStyle="width:300px;"/>
             	<@s.fielderror><@s.param>member.contact_name</@s.param></@s.fielderror>
             </td>
             <td class="table_name">联系人性别:</td>
             <td>
             	<@s.select  name="member.contact_sex" cssStyle="width:100px;" list=r"#{'先生':'先生','女士':'女士'}" />
          ...
          <tr>
           ...
           <tr>
              ...
              <input type="hidden" id="cat_attr_str" name="cat_attr_str" value="${cat_attr_str?if_exists}">
             	<div >
	                 ...
	                 <table>
	                 	...
	                 	<td><a class="oper_add" href="###" onclick="com_add_cat()"><input type='button' value="添加分类"/></a><@s.fielderror><@s.param>cate_attr</@s.param></@s.fielderror>   </td></tr>
	                 </table>		                 
		         </div>
             </td>
           </tr>
            ...
            <tr>
             ...
             <td colspan="3">
                <@s.radio name="member.cust_rage" list=r"#{'0':'供应商','1':'采购商','2':'二者皆有'}" value="${member.cust_rage?if_exists}"/>
