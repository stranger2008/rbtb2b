...
<div class="tj_main f_left">
   ...
   <div class="tj_main_cont">
   	<@s.form action="/admin_Advinfo_update.action?posid=${posid?if_exists}&two_pages_link=no" method="post" validate="true" onsubmit="return showPicPath();">
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">
         <tr>
           ...
           <tr id="moduletype" style="display:none;">
             ...
             <td colspan="5">
                <@s.select name="advinfo.module_type" list="modulecommparaList" listValue="para_key" id="paratype" listKey="para_value" headerKey="0" headerValue="请选择" />
           ...
           <tr id="advcontent" style="display:none;">
            ...
            <tr id="advintr" style="display:none;">
             ...
             <td colspan="5">
             	<@s.textfield id="intrvalue" name="advinfo.info_id" cssClass="txtinput" cssStyle="width:50px;" maxLength="100"/>
...
<!--显示信息-->
<div class="wrap" id="displayintr" style="display:none;height:450px;width:600px;overflow:scroll;" >
<table width="100%" border="0" cellspacing="0" class="indexTab">
  <tr style="background:url(images/top_tr.gif) repeat-x;">
     <td align="right">信息标题:</td>
     <td colspan="3"><@s.textfield name="intr_title" maxLength="20"/><input type="button" name="search" value="搜索" onclick="document.forms[0].submit();"/></td>
  </tr>
  <tr>
