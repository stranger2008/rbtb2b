...
<div class="tj_main f_left">
   <div class="pageLocation">
 	   当前位置:功能模块 > 分类信息管理 > 分类信息列表 > 修改分类信息
   </div>
   <div class="tj_main_cont">
   	<@s.form action="/admin_Classified_update.action" method="post" validate="true" onsubmit="return showPicPath();">
        <table class="wwtable" cellspacing="1" cellpadding="8">
          ...
          <tr>
               ...
               <td>
                <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <@s.hidden name="classified.cat_attr" />
              		 <a href="/admin_Classified_cate.action?cat_attr=0&classified.info_id=${classified.info_id?if_exists}">[重新选择]</a>
           ...
           <tr>
            ...
            <tr>
             ...
             <td>
             	<@s.radio name="classified.is_recom" list=r"#{'0':'否','1':'是'}"/>
             </td>
           </tr>
            <tr>
             <td class="table_name">内容收费:</td>
             <td>
             	<@s.textfield name="classified.fare" onkeyup="checkNum(this);" cssClass="txtinput" style="width:80px;" maxLength="10"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textfield name="classified.clicknum" onkeyup="checkNum(this);" cssClass="txtinput" style="width:80px;" maxLength="10"/>
	     ...
	     <div class="buttom">
	       ...
	       <@s.hidden name="classified.infoattr_id" />
