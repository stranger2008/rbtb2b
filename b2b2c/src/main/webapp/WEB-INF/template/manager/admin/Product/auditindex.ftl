...
<@s.form action="/admin_Product_auditList.action" method="post">
<div class="main_index f_left">
 <div class="pageLocation">
 	当前位置:功能模块 > 产品管理 > 产品审核列表
   </div>
 <div class="main_top">
   <ul class="main_top_ul">     
     <li class="shuaix"><a onclick="showSearch(this,'searchDiv');">筛选</a></li>
     <li class="sc"><a onclick="delInfo('product.product_id','/admin_Product_checkDel.action')">删除</a></li>
   </ul>
 </div>
 <div class="main_cont">
 ...
 <#list productList as sysproduct>
    ...
    <td align="left" class="audit_left">
     ...
     <a onclick=linkToInfo("/admin_Product_audit.action","product.product_id=${sysproduct.product_id?if_exists}");>
   ...
   <#else>
    ...
    <td align="center">
      <a onclick="linkToInfo('/admin_Product_auditList.action','cat_attr_s=${sysproduct.cat_attr_id?if_exists}');">${sysproduct.cat_attr?if_exists}</a>
   </td>
    <td align="center">
   ${sysproduct.area_attr?if_exists}</td>
   
   <td align="center" >
   <#if sysproduct.info_state?if_exists='0'>
    <a href="/admin_Product_auditList.action?info_state_s=0" ><span class="redcolor">未审核</span></a>
   <#elseif sysproduct.info_state?if_exists='2'>
   <a href="/admin_Product_auditList.action?info_state_s=2" >
   <span class="bluecolor">未通过</span></a>
   </#if></td>
    <td align="center" >${sysproduct.in_date?if_exists}</td>

    <td align="center"> <a onclick=linkToInfo("/admin_Product_audit.action","product.product_id=${sysproduct.product_id?if_exists}");><img src="/include/images/audit.png" /></a></td>
  </tr>
...
<div class="divceng" style="display:none;" id="searchDiv">
	...
	<tr>
		...
		<td>
		<@s.select name="info_state_s" cssStyle="width:100px;" list=r"#{'4':'请选择','0':'未审核','2':'未通过'}"   /> </td>
	</tr>
	<tr>
