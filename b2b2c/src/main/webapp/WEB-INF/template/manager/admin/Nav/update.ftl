...
<div class="tj_main f_left">
 <div class="pageLocation">
   ...
   <div class="tj_main_cont">
   	...
   	<@s.form action="/admin_Nav_update.action" method="post" validate="true">
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">
           ...
           <tr>
            ...
            <tr>
             ...
             <td>
             	 <@s.select  list="commparalist" id="codeselect"  listValue="module_name" listKey="module_type" headerKey="" headerValue="请选择" />
