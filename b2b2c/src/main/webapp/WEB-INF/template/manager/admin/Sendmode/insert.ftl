...
<div class="tj_main f_left">
   <div class="pageLocation">
 	当前位置:商城管理 > 系统配置 > 添加配送方式
   </div>
   <div class="tj_main_cont">
   	<@s.form action="/admin_Sendmode_insert.action" method="post" validate="true" >
        <table class="wwtable" cellspacing="1" cellpadding="8">
	              ...
	              <tr>
		             ...
		             <td>
		                 <@s.radio name="sendmode.reach_pay" list=r"#{'1':'否','0':'是'}" value="1"/>
		           ...
		           <tr>
		             ...
		             <td>
		                <@s.radio name="sendmode.is_insured" list=r"#{'1':'否','0':'是'}" value="1"/>
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="sendmode.rate" value='0' cssClass="txtinput" cssStyle="width:80px;" maxLength="11"/>
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="sendmode.mix_insured" value='0' cssClass="txtinput" cssStyle="width:100px;" maxLength="11"/>
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="sendmode.max_insured" value='0' cssClass="txtinput" cssStyle="width:100px;" maxLength="11"/>
