...
<div class="tj_main f_left">
   <div class="pageLocation">
 	   当前位置:会员管理 > 企业会员 > 企业站模板管理 > 添加模板
   </div>
   <div class="tj_main_cont">
   
   	<@s.form action="/admin_Membertemplate_insert.action" method="post" validate="true">
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">
           ...
           <tr>
             <td width="19%" class="table_name">模板编码<font color='red'>*</font></td>
             <td colspan="2">
             	<@s.textfield name="membertemplate.temp_code" cssClass="txtinput" maxLength="20"/>
             	<@s.fielderror><@s.param>membertemplate.temp_code</@s.param></@s.fielderror>
             </td>
           </tr>
            ...
            <td>
             	<@s.radio name="membertemplate.p_unit" list=r"#{'0':'积分','1':'资金'}" value="0"/>
            ...
            <tr>
             ...
             <td colspan="2">
             	<@s.textfield name="membertemplate.sort_no" value="0" cssClass="txtinput" style="width:80px;" maxLength="4"/>
           ...
           <tr>
             ...
             <td colspan="2"> 
                <@s.checkboxlist id="status" name="membertemplate.mem_level" list="memberlevleList" listKey="level_id" headerKey="0" 	listValue="level_name"  >
                </@s.checkboxlist>
