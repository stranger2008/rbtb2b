...
<div class="tj_main f_left">
   <div class="pageLocation">
 	当前位置:功能模块 > 分类管理 > 分类管理 > 修改${modules?if_exists}分类
   </div>
   <div class="tj_main_cont">   
   	<@s.form action="/admin_Category_update.action" method="post" validate="true">  
        <table class="wwtable" cellspacing="1" cellpadding="8">
           <tr>
             <td width="19%" class="table_name">分类名称<font color='red'>*</font></td>
             <td>
             	<@s.textfield id="cat_name" name="category.cat_name" cssClass="txtinput" maxLength="50" />
           ...
           <tr>
             ...
             <td>
             	<@s.radio name="category.is_display" list=r"#{'1':'显示','0':'不显示'}"  checked="true" />
           ...
           <tr>
             ...
             <td>
             	<@s.textfield  id="sort_no"  name="category.sort_no" cssClass="txtinput" maxLength="6" onkeyup="checkNum(this);"/>
           ...
           <tr>
            ...
            <tr>
             ...
             <td>
             		<@s.textarea name="category.seotitle" cssClass="mailCss"  maxlength="100" calss="area"/>
           ...
           <tr>
             ...
             <td>
             		<@s.textarea name="category.seokeyword" cssClass="mailCss"  maxlength="100"  calss="area"/>
            ...
            <tr>
             ...
             <td>
             		<@s.textarea name="category.seodesc" cssClass="mailCss"  maxlength="200" calss="area"/>
