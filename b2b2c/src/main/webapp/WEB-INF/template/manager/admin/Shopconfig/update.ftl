  ...
  <head>
    ...
    <script src="/include/js/admin/pitureshow.js" type="text/javascript"></script>	
	  ...
	  $(document).ready(function(){    
         //图片展示
         firstaddimges("mypicid","addimg","80","80");
         
         //图片展示
         firstaddimges("mypicid1","addimg1","80","80");
         
         //图片展示
         firstaddimges("mypicid2","addimg2","80","80");
...
<div class="tj_main f_left">
   <div class="pageLocation">
 	当前位置:商城管理 > 店铺管理 > 查看店铺设置
   </div>
   <div class="tj_main_cont">
   	<@s.form action="/admin_Shopconfig_update.action" method="post" validate="true" >
        <table class="wwtable" cellspacing="1" cellpadding="8">
		           ...
		           <tr>
		            ...
		            <tr>
		             ...
		             <td>
		              <@s.radio name="shopconfig.info_state" list=r"#{'1':'正常','3':'禁用'}"  /> 
