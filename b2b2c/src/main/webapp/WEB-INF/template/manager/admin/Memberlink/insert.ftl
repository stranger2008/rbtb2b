...
<div class="tj_main f_left">
   <div class="pageLocation">
 	   当前位置:会员管理 > 企业会员 > 友情链接管理 > 添加企业友情链接
   </div>
   <div class="tj_main_cont">
   
   	<@s.form action="/admin_Memberlink_insert.action" method="post" validate="true">
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">   
           ...
           <tr>
            <td class="table_name">链接状态:</td>
             <td>
                 <@s.radio name="memberlink.link_state" list=r"#{'0':'通过','1':'未审核','2':'未通过'}" value="0"/>
