...
<div class="tj_main f_left">
   ...
   <div class="tj_main_cont">
   	<@s.form id='shipfrom' action="/admin_Shiptemplate_update.action" method="post" validate="true" >
        <table class="wwtable" cellspacing="1" cellpadding="8">
	     ...
	     <div class="buttom">
			 ...
			 <!--所属地区插件隐藏字段结束区域-->    
	         <input type="button" name="returnList" value="返回列表" onclick="linkToInfo('/admin_Shiptemplate_list.action','');"/>
	     </div>
	     <!--获取系统的所有地区-->
		<div class='showareadiv1'>
			...
			<div class='areabottom'>
				...
				<!--触发不同的方法名-->
				<@s.hidden id="sel_submit" value="2"/>
