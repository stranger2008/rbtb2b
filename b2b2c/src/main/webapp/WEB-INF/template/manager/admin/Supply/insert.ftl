...
<div class="tj_main f_left">
 <div class="pageLocation">
   ...
   <div class="tj_main_cont">
   	<@s.form id="supply_add" action="/admin_Supply_insert.action"  method="post" validate="true"> 	`
           ...
           <tr>
             ...
             <td>
             	<#if sysmodule.is_catattr=="0">             
	                 ...
	                 <a href="/admin_Supply_cate.action?cat_attr=0">[重新选择]</a>
        ...
        <@s.fielderror><@s.param>supply.img_path</@s.param></@s.fielderror>	  
           ...
           <tr>
             ...
             <td>
                ...
                <img class='ltip' src="/include/images/light.gif" alt="<@s.property value="%{getText('manager.admin.Supply.price')}"/>"> 
                 <@s.fielderror><@s.param>supply.price</@s.param></@s.fielderror>
                </td></tr>      
                ...
                <td>自买家付款之日起<@s.textfield  name="supply.send_day" cssClass="datenum" id="send_day"  maxlength="20" onkeyup="checkNum(this);"/>天内发货
                <@s.fielderror><@s.param>supply.send_day</@s.param></@s.fielderror></td></tr>  
                
                <tr><td class="zitd">运费<font color="red">*</font></td>
                <td><@s.textfield  name="supply.shipfee" cssClass="zitxt" value="0" maxlength="20" />&nbsp;元
           ...
           <tr>
             ...
             <td>
             	<@s.textfield  id="endtime" cssClass="Wdate"  name="supply.end_date" onfocus="WdatePicker()" />
           ...
           <tr>
             ...
             <td>
             	<@s.textfield  name="supply.clicknum" cssClass="txtinput" maxlength="11" value="0" onkeyup="checkNum(this);"/>
          ...
          <tr>
             ...
             <td>
                  <@s.radio name="supply.info_state" list=r"#{'0':'未审核','1':'正常','2':'未通过','3':'禁用'}" value="1" /> 	     
