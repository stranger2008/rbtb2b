...
<@s.hidden name="attrvalue.is_recom" id="admin_attrvalue_state"/>
<div class="main_index f_left">
 ...
 <div class="main_cont">
  ...
  <tr>
    ...
    <td align="center"><a onclick="linkToInfo('/admin_Attrvalue_view.action','attrvalue.trade_id=${attrvalue.trade_id?if_exists}');"><img src="/include/images/bj.gif" /></a></td>
  </tr>
  </#list>
</table>
 </div>
