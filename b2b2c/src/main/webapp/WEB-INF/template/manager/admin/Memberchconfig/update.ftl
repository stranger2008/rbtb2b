...
<div class="tj_main f_left">
   <div class="pageLocation">
 	   当前位置:会员管理 > 企业会员 > 栏目配置管理 > 修改栏目
   </div>
   <div class="tj_main_cont">
   	<@s.form action="/admin_Memberchconfig_update.action" method="post" validate="true">
        <table class="wwtable" cellspacing="1" cellpadding="8">
           ...
           <tr>
             ...
             <td>
             	<@s.textfield name="memberchconfig.ch_code" cssClass="txtinput" maxLength="20"/>
             ...
             <td>
             	<@s.select name="memberchconfig.ch_type" list=r"#{'0':'菜单','1':'侧栏','2':'首页'}" />  
           ...
           <tr>
             ...
             <td>
             	<@s.radio name="memberchconfig.is_dis" list=r"#{'0':'显示','1':'不显示'}"/>
             </td>
           </tr>
            <tr>
             <td class="table_name">排序:</td>
             <td>
             	<@s.textfield name="memberchconfig.sort_no" cssClass="txtinput" style="width:80px;" maxLength="4"/>
            ...
            <tr>
             ...
             <td>
             	<@s.textfield name="memberchconfig.ch_num"  cssClass="txtinput" style="width:80px;" maxLength="4"/>
	     ...
	     <div class="buttom">
	       ...
	       <@s.hidden name="memberchconfig.ch_id"/>
