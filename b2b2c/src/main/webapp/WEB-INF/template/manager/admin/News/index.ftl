...
<@s.form action="/admin_News_list.action" method="post">
...
<div class="main_index f_left">
 ...
 <div class="main_top">
   <ul class="main_top_ul">
     <li class="tj"><a onclick="linkToInfo('/admin_News_cate.action','');">添加资讯</a></li>
     <li class="qiyong"><a onclick="updateRecomState('1','news.news_id','/admin_News_updateisrecom.action?isrecom=1','admin_news_state');">推荐</a></li>
     <li class="jingyong"><a onclick="updateRecomState('0','news.news_id','/admin_News_updateisrecom.action','admin_news_state');">取消推荐</a></li>
     <li class="sc"><a onclick="delInfo('news.news_id','/admin_News_delete.action')">删除</a></li>
 ...
 <div class="main_cont">
  ...
  <tr style="background:url(images/top_tr.gif) repeat-x;">
    ...
    <td width="13%" align="center" class="top_td">会员名称</td>
    <td width="10%"  align="center" class="top_td">分类</td>
    <td width="10%"  align="center" class="top_td">地区</td>
    <td width="7%" align="center" class="top_td">资讯状态</td>
  ...
  <#list newsList as sysnews>
    ...
    <#if sysnews.title?if_exists!=''>
    	<a onclick=linkToInfo("/admin_News_view.action","news.news_id=${sysnews.news_id?if_exists}");>
     ...
     <td align="center">
      <a href="/admin_Member_viewinfo.action?member.cust_id=${(sysnews.cust_id)?if_exists}" target="_blank">
    ...
    <td align="center">
          <a onclick="linkToInfo('/admin_News_list.action','cat_attr_s=${sysnews.cat_attr_id?if_exists}');">${sysnews.cat_attr?if_exists}</a>
    </td>
   ...
   <font class="bluecolor">  
    ...
    <td align="center">
    	<a onclick=linkToInfo("/admin_News_view.action","news.news_id=${sysnews.news_id?if_exists}");><img src="/include/images/bj.gif" /></a>
    </td>
  </tr>
...
<div class="divceng" style="display:none;" id="searchDiv">
	...
	<tr>
		...
		<td>
		<@s.select name="state_code_s" list=r"#{'4':'请选择','0':'正常','3':'禁用'}"   /> </td>
	</tr>
	<tr>
