...
<div class="tj_main f_left">
   <div class="pageLocation">
 	当前位置:商城管理 > 商品管理 > 修改商品品牌
   </div>
   <div class="tj_main_cont">
   	<@s.form action="/admin_Goodsbrand_update.action" method="post" validate="true" id="com_insert" >
        <table class="wwtable" cellspacing="1" cellpadding="8">
             	...
             	<div >
	                 <table>
	                 	<tr><td  colspan="2" class="tdbottom"><div id="divlist" style="margin-left:-10px;"></div></td>
	                 	<td class="tdbottom"><a class="oper_add" href="###" onclick="com_add_cat()">[新增分类]</a><@s.fielderror><@s.param>goodsbrand.goods_attr</@s.param></@s.fielderror>   </td></tr>
	                 </table>	
	                 <div id="show_add_cat">
		           ...
		           <tr>
		             ...
		             <td>
		              <@s.radio name="goodsbrand.info_state" list=r"#{'0':'正常','1':'禁用'}" /> 
		           ...
		           <tr> 
			             ...
			             <td >
			              	<@s.radio name="goodsbrand.is_recom" list=r"#{'0':'否','1':'是'}"   /> 
	     ...
	     <div class="buttom">
	       ...
	       ${listSearchHiddenField?if_exists}
	        <@s.hidden name="goodsbrand.brand_id"/>
	          <!--所属分类插件隐藏字段开始区域-->
