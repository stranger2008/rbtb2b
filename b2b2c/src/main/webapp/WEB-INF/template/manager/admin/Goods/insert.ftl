...
<div class="tj_main f_left">
   ...
   <div class="tj_main_cont">
   	<@s.form action="/admin_Goods_insert.action" method="post" validate="true" >
		  ...
		  <tr>
             ...
             <td  colspan="5">
             	<#if sysmodule.is_catattr=="0">             
	                 ...
	                 <a href="/admin_Goods_cate.action?cat_attr=0">[重新选择]</a>
		 ...
		 <tr>
		             ...
		             <td colspan="5">
		             	<@s.textfield id="cp" name="goods.cost_price" cssClass="txtinput" maxLength="20" onkeyup="calculate(this.value);"  value="0.0"/>
				...
				<tr>
		             ...
		             <td colspan="3">
		             	<@s.textfield id="gmarket" name="goods.market_price" cssClass="txtinput" maxLength="20"  value="0.0" />
				...
				<#if malllevelList!=null&&(malllevelList?size>(0))>
	                     	 ...
	                     	 <#else>
		                   	 ...
		                   	 <span>	
		                   	     <input type="hidden" name="memName" value="${mlevel.level_name?if_exists}"/>	                   	 	 	                   	     
		                   	  	 <input type="text" name="memPrice" style="width:100px;" value="${dislevel?if_exists}"  value="0.0"/>
		                   	 </span>
		           ...
		           <tr>
		             ...
		             <td colspan="5">
		             	<@s.textfield name="goods.total_stock" cssClass="txtinput" maxLength="20" value="0"/>
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="goods.now_stock" cssClass="txtinput" maxLength="20" value="0"/>
		             	<@s.fielderror><@s.param>goods.now_stock</@s.param></@s.fielderror>
		             </td>
		             <td class="table_name">提醒库存:</td>
		             <td colspan="3">
		             	<@s.textfield name="goods.warn_stock" cssClass="txtinput" maxLength="20" value="0"/>
		           ...
		           <tr>
		             ...
		             <td colspan="5">
		             	<@s.textfield name="goods.saled_num" cssClass="txtinput" maxLength="20" value="0"/>
      ...
      <table class="wwtable" cellspacing="1" cellpadding="8">
	           ...
	           <tr>
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="goods.give_inter" cssClass="txtinput" maxLength="20" value="0"/>
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="goods.interbuy" cssClass="txtinput" maxLength="20" value="0"/>
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="goods.weight"  cssClass="txtinput" maxLength="20" value="0"/>(kg)
				...
				<tr>
		             ...
		             <td>
		             	<@s.textfield name="goods.volume"  cssClass="txtinput" maxLength="20" onkeyup="checkNum(this);" value="0"/>(m<sup>3</sup>)
		           ...
		           <tr>
		             ...
		             <td>
						<@s.radio id='is_ship' name="goods.is_ship" list=r"#{'0':'免运费','1':'半自动','2':'全自动'}"/>  
		          ...
		          <tr>
		             ...
		             <td>
		                  <@s.radio name="goods.info_state" list=r"#{'0':'未审核','1':'正常','2':'未通过','3':'禁用'}" value="1" />    
