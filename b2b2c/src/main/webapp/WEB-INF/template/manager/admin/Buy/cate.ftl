<html>
  ...
  <body >
<@s.form action="/admin_Buy_gopage.action"  method="post" validate="true"> 
...
<div class="main_index f_left">
 <div class="pageLocation">
	 ...
	 <div class="main_cont"  style="height:800px;">      
	   <table width="100%">
	      <tr><td><span style="font-size:14px;">请选择分类至最后一级:</span>&nbsp;&nbsp;<a href="admin_Category_list.action?type=buy&ajaxRequestRandom=1" target="_blank">[分类管理]</a><@s.fielderror><@s.param>cate_attr</@s.param></@s.fielderror></td></tr>
