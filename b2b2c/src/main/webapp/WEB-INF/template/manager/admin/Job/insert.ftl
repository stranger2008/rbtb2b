...
<div class="tj_main f_left">
 <div class="pageLocation">
   ...
   <div class="tj_main_cont">
   	<@s.form action="/admin_Job_insert.action" method="post" validate="true">
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">
            ...
            <tr>
             ...
             <td colspan="3">
              ...
              <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <a href="/admin_Job_cate.action?cat_attr=0">[重新选择]</a>
         ...
         <tr>
            ...
            <td class="table_name">过期时间<font color='red'> *</font></td>
             <td >
            <@s.textfield  id="txtendDate" name="job.end_date" cssClass="Wdate" onfocus="WdatePicker({readOnly:true})" />
              <@s.fielderror><@s.param>job.end_date</@s.param></@s.fielderror>
             </td>
           </tr>   
              
            <tr>
             <td class="table_name">职位描述<font color='red'> *</font></td>
             <td colspan="3">
            ...
            <tr>
             ...
             <td colspan="3">
             	<@s.textfield name="job.fare" cssStyle="width:100px;"  cssClass="txtinput" maxLength="100" value="0" onkeyup="checkNum(this);"/>
            ...
            <tr>
             ...
             <td >
                 <@s.radio name="job.is_recom" list=r"#{'0':'否','1':'是'}" value="0" />     	
             </td>
           </tr>
            <tr>
             ...
             <td >
             	<@s.textfield name="job.clicknum" cssClass="txtinput" maxLength="20"  cssStyle="width:100px;" value="0" onkeyup="checkNum(this);"/>
           ...
           <tr>
             ...
             <td >
             	 <@s.radio name="job.is_where" list=r"#{'0':'国内招聘','1':'海外招聘'}" value="0"/> 
             </td>
              <td class="table_name">是否委托:</td>
             <td >
             	 <@s.radio name="job.is_trust" list=r"#{'0':'否','1':'是'}" value="0"/> 
             </td>
           </tr>   
             <tr>
             <td class="table_name"  >信息状态:</td>
             <td colspan="3">
               <@s.radio name="job.info_state" list=r"#{'0':'未审核','1':'审核通过','2':'审核未通过','3':'禁用'}" value="1" />  
