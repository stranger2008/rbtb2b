          ...
          <div class="con_connent">
                 ...
                 <#list countlist as count>
	              ...
	              <li>
	               ...
	               <li>
                        <span class="yw_abc yw_a" >企业新闻:</span>
                        <span class="yw_abc yw_b" >未审核</span> 
                        <span class="yw_abc yw_c" ><a  href="/admin_Membernews_list.action?news_state_s=1">${newsaudit?if_exists}</a></span> 
                        <span class="yw_abc yw_d" > 条 </span>    
                        <span class="yw_abc yw_bb">今日新增:</span> 
                        <span class="yw_abc yw_c" ><a href="/admin_Membernews_list.action?today=now">${newscount?if_exists}</a></span> 
                        <span class="yw_abc yw_d" > 条 </span>                    
	              </li>
	              
	              <li>
                        <span class="yw_abc yw_a" >友情链接:</span>
                        <span class="yw_abc yw_b" >未审核</span> 
                        <span class="yw_abc yw_c" ><a  href="/admin_Membernews_list.action?news_state_s=1">${newsaudit?if_exists}</a></span> 
                        <span class="yw_abc yw_d" > 条 </span>    
                        <span class="yw_abc yw_bb">今日新增:</span> 
