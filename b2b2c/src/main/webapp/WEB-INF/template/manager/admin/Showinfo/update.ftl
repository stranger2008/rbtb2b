...
<div class="tj_main f_left">
 <div class="pageLocation">
 	当前位置:功能模块 > 展会管理 > 展会列表 > 修改展会
   </div>
   <div class="tj_main_cont">
   	<@s.form  action="/admin_Showinfo_update.action" method="post" validate="true">
        <table class="wwtable" cellspacing="1" cellpadding="8">
             ...
             <td colspan="3" >
               ...
               <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <@s.hidden name="showinfo.cat_attr" />
              		<a href="/admin_Showinfo_cate.action?cat_attr=0&showinfo.exh_id=${showinfo.exh_id?if_exists}">[重新选择]</a>
            ...
            <tr>
             ...
             <td >
              <#if showinfo.start_date?if_exists?length lt 10>
             	  <@s.textfield id="txtstartDate" name="showinfo.start_date"  type="text" cssClass="Wdate"  readonly="true" onclick="WdatePicker({maxDate:'#F{$dp.$D(\\'txtendDate\\',{d:1})}',readOnly:true})" 
                  value="${showinfo.start_date?if_exists}" />      
             <#else>
	              <@s.textfield id="txtstartDate" name="showinfo.start_date"  type="text" cssClass="Wdate"  readonly="true" onclick="WdatePicker({maxDate:'#F{$dp.$D(\\'txtendDate\\',{d:1})}',readOnly:true})" 
	              value="${showinfo.start_date?if_exists[0..9]}  " />                	        
             </#if>
             ...
             <td >
              <#if showinfo.end_date?if_exists?length lt 10>
             	  <@s.textfield id="txtendDate" name="showinfo.end_date"  type="text" cssClass="Wdate"  readonly="true" onclick="WdatePicker({minDate:'#F{$dp.$D(\\'txtstartDate\\',{d:1})}',readOnly:true})"  
                  value="${showinfo.end_date?if_exists}" />      
             <#else>
	              <@s.textfield id="txtendDate" name="showinfo.end_date"  type="text" cssClass="Wdate"  readonly="true" onclick="WdatePicker({minDate:'#F{$dp.$D(\\'txtstartDate\\',{d:1})}',readOnly:true})"  
	              value="${showinfo.end_date?if_exists[0..9]}  " />                	        
             </#if>
          ...
          <tr>
           ...
           <tr>
             ...
             <td >
             	 <@s.radio name="showinfo.is_recom" list=r"#{'0':'否','1':'是'}"  />  
             	 	 <@s.fielderror><@s.param>showinfo.is_recom</@s.param ></@s.fielderror >   	
             </td>
               <td class="table_name">点击量:</td>
             <td >  
             	<@s.textfield name="showinfo.clicknum" cssClass="txtinput" onkeyup="checkNum(this);" />
             ...
             <td colspan="3" >
             	<@s.textfield name="showinfo.fare" cssClass="txtinput" maxLength="20" onkeyup="checkNum(this);"/>
            ...
            <tr>
             ...
             <td colspan="3" >
               <@s.radio name="showinfo.info_state" list=r"#{'1':'正常','3':'禁用'}"  />   
	     ...
	     <div class="buttom">
	       ...
	       <@s.hidden name="showinfo.exh_id" id="id"/>
	       ${listSearchHiddenField?if_exists}
	     <@s.hidden name="showinfo.infoattr_id" />
           <#if sysmodule.is_catattr=="0">      
	      ...
	      <input type="button" name="sumit" value="重置" onclick="resetModify('/admin_Showinfo_view.action?showinfo.exh_id=');" />
	       <!--所属分类插件隐藏字段开始区域-->
