<html>
  <head>
    <title>添加会员等级设置</title>
    <#include "/include/uploadInc.html">
  </head>
  <body>
<div class="tj_main f_left">
   <div class="pageLocation">
 	当前位置:商城管理 > 系统设置 > 添加会员等级设置
   </div>
   <div class="tj_main_cont">
   	<@s.form action="/admin_Malllevelset_insert.action" method="post" validate="true" >
        <table class="wwtable" cellspacing="1" cellpadding="8">
		           ...
		           <tr>
		             ...
		             <td>
		                <@s.radio name="malllevelset.mem_type" list=r"#{'0':'卖家','1':'买家'}" value="0" /> 
