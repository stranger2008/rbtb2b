...
<div class="tj_main f_left">
   <div class="pageLocation">
 	当前位置:功能模块 > 图库管理 > 图库列表 > 修改图库
   </div>
   <div class="tj_main_cont">
   	<@s.form action="/admin_Gallery_update.action" method="post" validate="true">
        <table class="wwtable" cellspacing="1" cellpadding="8">
           <tr>
             <td class="table_name">图库标题<font color='red'>*</font></td>
             <td>
             	<@s.textfield name="gallery.title" cssClass="txtinput" maxLength="20"/>
             ...
             <td>
                 <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <@s.hidden name="gallery.cat_attr" />
              		<a href="/admin_Gallery_cate.action?cat_attr=0&gallery.gal_id=${gallery.gal_id?if_exists}">[重新选择]</a>
         ...
         <#if sysmodule.is_catattr=="0">      
          ...
          <tr>
            ...
            <tr>
             ...
             <td>
             	<@s.radio name="gallery.is_recom" list=r"#{'0':'否','1':'是'}"/>
             </td>
           </tr>
             <tr>
             <td class="table_name">状态:</td>
             <td>
             	<@s.radio name="gallery.info_state" list=r"#{'1':' 正常','3':'禁用'}"/>
             </td>
           </tr>
         </table>
	     <div class="buttom">
