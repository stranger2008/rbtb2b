...
<div class="tj_main f_left">
   ...
   <div class="tj_main_cont">
   	<@s.form action="/admin_Groupgoods_insert.action" method="post" validate="true" >
        <table class="wwtable" cellspacing="1" cellpadding="8">
       		   <script type="text/javascript">
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield id="ggname" name="groupname"  cssClass="txtinput" cssStyle="width:300px;" disabled='true'  />
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.textfield name="groupgoods.cust_maxbuy" cssClass="txtinput" onkeyup="checkNum(this);" value="0"/>
		           ...
		           <tr>
		             <td class="table_name">最低团购量<font color='red'>*</font></td>
		             <td>
		           ...
		           <tr>
		             <td class="table_name">最高团购量<font color='red'>*</font></td>
		             <td>
		           ...
		           <tr>
		             ...
		             <td>
		             	 <@s.radio name="groupgoods.is_seven" list=r"#{'0':'是','1':'否'}" value="1" />  
		           ...
		           <tr>
		             ...
		             <td>
		             	 <@s.radio name="groupgoods.is_overdue" list=r"#{'0':'是','1':'否'}" value="1" />  
		           ...
		           <tr>
		             ...
		             <td>
		             	<@s.radio name="groupgoods.is_ship" list=r"#{'0':'是','1':'否'}" value="1" />  
