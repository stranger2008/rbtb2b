...
<div class="tj_main f_left">
 <div class="pageLocation">
   ...
   <div class="tj_main_cont">
   	<@s.form action="/admin_Product_insert.action" method="post" validate="true">
        <table class="wwtable" cellspacing="1" cellpadding="8">
           ...
           <tr>
            <td class="table_name">所属分类<font color='red'> *</font></td>
             ...
             <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <a href="/admin_Product_cate.action?cat_attr=0">[重新选择]</a>
           ...
           <tr style="display:none;">
             ...
             <td >
                <@s.textfield name="product.attr_desc" value="0" cssClass="txtinput" cssStyle="width:300px;display:none;" />
           ...
           <tr style="display:none;">
            ...
            <tr>
             ...
             <td >
              <@s.radio name="product.is_recom" list=r"#{'0':'否','1':'是'}" value='0'  /> 
             ...
             <td >
             	<@s.textfield name="product.clicknum" cssClass="txtinput" cssStyle="width:100px;" maxLength="100" value="0" onkeyup="checkNum(this);"/>
             ...
             <td >
             	<@s.textfield name="product.fare" cssClass="txtinput" cssStyle="width:100px;" maxLength="100" value="0" onkeyup="checkNum(this);"/>
            ...
            <tr> 
             ...
             <td >
              <@s.radio name="product.info_state" list=r"#{'0':'未审核','1':'审核通过','2':'审核未通过','3':'禁用'}" value='1'  /> 
