...
<div class="tj_main f_left">
   ...
   <div class="tj_main_cont">
   	<@s.form action="/admin_Channel_update.action" method="post" validate="true">
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">
           ...
           <tr>
             ...
             <td>
             	<@s.textfield name="channel.file_name" cssClass="txtinput" maxLength="20" cssStyle="width:200px;"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textarea name="channel.meta_keyword" cssClass="txtinput" onkeyup="set_textarea_length(this,200);" cssStyle="width:300px;"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textarea name="channel.meta_desc" cssClass="txtinput" onkeyup="set_textarea_length(this,200);" cssStyle="width:300px;"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textarea name="channel.remark" cssClass="txtinput"  onkeyup="set_textarea_length(this,100);" cssStyle="width:300px;"/>
