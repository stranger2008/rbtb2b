...
<div class="tj_main f_left">
 <div class="pageLocation">
 	   当前位置:会员管理 > 企业会员 > 添加企业会员
 </div>
   <div class="tj_main_cont">
   	<@s.form  id="com_insert"  action="/admin_Corpomember_insert.action" method="post" validate="true">
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">
           ...
           <tr>
            ...
            <tr>
             ...
             <td colspan="3">
             	<@s.radio name="member.info_state" list=r"#{'1':'审核通过','3':'禁用'}" value="1"/>
           ...
           <tr>
            ...
            <tr>
             ...
             <td colspan="3">
				...
				<div ><@s.fielderror><@s.param>member.cust_desc</@s.param></@s.fielderror></div>
