...
<div class="tj_main f_left">
  <div class="pageLocation">
   ...
   <div class="tj_main_cont">
   	<@s.form action="/admin_Advpos_update.action" method="post" validate="true">
           ...
           <tr id="size" style="display:none;">
            ...
            <tr>
             ...
             <td>
             	...
             	<img class='ltip' src="/include/images/light.gif"  alt='<@s.property value="%{getText('manager.price')}"/>'> 
