...
<div class="tj_main f_left">
   <div class="pageLocation">
 	当前位置:功能模块 > 知道管理 > 知道列表 > 修改知道
   </div>
   <div class="tj_main_cont">
   
   	<@s.form action="/admin_Ask_update.action" method="post" validate="true">
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">
             ...
             <td>
             	<#if sysmodule.is_catattr=="0">             
	                 ...
	                 <@s.hidden name="buy.cat_attr" />
              		<a href="/admin_Ask_cate.action?cat_attr=0&ask.ask_id=${ask.ask_id?if_exists}">[重新选择]</a>
           ...
           <tr>
            ...
            <tr>
             ...
             <td>
                <@s.radio name="ask.is_recom" list=r"#{'0':'否','1':'是'}"/>
            ...
            <tr>
             ...
             <td>
             	<@s.radio name="ask.info_state" list=r"#{'1':'正常','3':'禁用'}"/>
            ...
            <tr>
             ...
             <td>
             	<@s.radio name="ask.answer_state" list=r"#{'0':'未解决','1':'已解决','2':'已关闭'}"/>
            ...
            <tr>
             ...
             <td>
             	<@s.textfield name="ask.clicknum" onkeyup="checkNum(this);" cssClass="txtinput" maxLength="11" value="0" onkeyup="checkNum(this);" />
...
<div class="wrap" id="displaypicture" style="display:none;">
	    <div  align="right"> <a onclick="closeshow();"  href="###" >
	    <img src="/include/components/upload/close.png" /></a></div>
