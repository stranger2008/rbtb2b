...
<div class="tj_main f_left">
 <div class="pageLocation">
 	当前位置:功能模块 > 视频管理 > 视频列表 > 修改视频
   </div>
   <div class="tj_main_cont">
   	<@s.form action="/admin_Video_update.action" method="post" onsubmit="return showPicPath();" validate="true">
        <table class="wwtable" cellspacing="1" cellpadding="8">
             ...
             <td>
                <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <@s.hidden name="video.cat_attr" />
              		<a href="/admin_Video_cate.action?cat_attr=0&video.video_id=${video.video_id?if_exists}">[重新选择]</a>
         ...
         <#if sysmodule.is_catattr=="0">      
            ...
            <tr>
             ...
             <td>
             	<@s.radio name="video.is_recom" list=r"#{'0':'否','1':'是'}"/>
             ...
             <td>
             	<@s.textfield name="video.fare" cssClass="txtinput" style="width:80px;" onkeyup="checkNum(this);" maxLength="10"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textfield name="video.clicknum" cssClass="txtinput" style="width:80px;" onkeyup="checkNum(this);" maxLength="10"/>
            ...
            <tr>
             ...
             <td>
             	<@s.radio name="video.info_state" list=r"#{'1':'正常','3':'禁用'}"  checked="true" />        
