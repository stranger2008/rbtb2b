...
<div class="tj_main f_left">
   <div class="tj_main_cont">
   	...
   	<@s.form action="/admin_Voteoption_insert.action" method="post" validate="true" >
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">
             ...
             <td>
             	<@s.textfield name="vote_option.option_count" value="0" cssClass="txtinput" style="width:80px;" maxLength="8"/>
	     ...
	     <div class="buttom">
	       ...
	       <@s.submit value="保存"/>
	       <@s.reset value="重置"/>
	       <input type="button" name="returnList" value="返回列表" onclick="linkToInfo('/admin_Voteoption_list.action','vote_id=${vote_id?if_exists}');"/>
	     </div>
