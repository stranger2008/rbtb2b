...
<div class="tj_main f_left">
   <div class="pageLocation">
 	当前位置:商城管理 > 促销管理 > 更新优惠券
   </div>
   <div class="tj_main_cont">
   	<@s.form action="/admin_Coupon_update.action" method="post" validate="true" >
        <table class="wwtable" cellspacing="1" cellpadding="8">
		          ...
		          <tr>
		           ...
		           <tr id="zhekou" style="display:none">
		             ...
		             <td>
		             	<@s.textfield name="coupon.c_discount" cssStyle="width:100px" cssClass="txtinput" maxLength="20"/>(折扣数1-100)
