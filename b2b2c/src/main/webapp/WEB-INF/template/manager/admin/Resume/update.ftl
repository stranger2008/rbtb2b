...
<div class="tj_main f_left">
 <div class="pageLocation">
 	当前位置:功能模块 > 人才管理 > 简历列表 > 修改简历
   </div>
   <div class="tj_main_cont">
   	<@s.form  method="post" action="/admin_Resume_update.action" validate="true">
       <table class="wwtable" cellspacing="1" cellpadding="8" >
             ...
             <td colspan="3">
               ...
               <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <@s.hidden name="resume.cat_attr" />
              		<a href="/admin_Resume_cate.action?cat_attr=0&resume.resume_id=${resume.resume_id?if_exists}">[重新选择]</a>
           ...
           <td class="table_name">婚姻状况:</td>
            ...
            <tr>
             ...
             <#if resume.birth?if_exists?length lt 10>
               <@s.textfield cssClass="Wdate"   name="resume.birth" onfocus="WdatePicker({readOnly:true})" />
             <#else>
             <@s.textfield cssClass="Wdate" value="${resume.birth?if_exists[0..9]}"  name="resume.birth" onfocus="WdatePicker({readOnly:true})" />         
             </#if>
         ...
         <tr>
             ...
             <td >
             	<@s.textfield name="resume.work_exper" cssStyle="width:50px;" onkeyup="checkNum(this);"  cssClass="txtinput" maxLength="2"/> 年
            ...
            <tr>
             ...
             <td >
             	<@s.textfield name="resume.cellphone" cssClass="txtinput" maxLength="20" onkeyup="checkNum(this);"  cssStyle="width:300px;"/>
             	<@s.fielderror><@s.param>resume.cellphone</@s.param></@s.fielderror>
             </td>
              <td class="table_name"  >联系电话:</td>
             <td colspan="3">
             	<@s.textfield name="resume.phone" cssStyle="width:300px;"  cssClass="txtinput" maxLength="100" />
            ...
            <tr>
             ...
             <td >
             	<@s.textfield name="resume.email" cssStyle="width:300px;" cssClass="txtinput" maxLength="60"/>
            ...
            <tr>
             ...
             <td >
              <@s.radio name="resume.is_recom" list=r"#{'0':'否','1':'是'}"  />     
            ...
            <tr>
             ...
             <td >
             	<@s.textfield name="resume.clicknum" cssClass="txtinput" maxLength="20" onkeyup="checkNum(this);"  cssStyle="width:100px;"/>
             ...
             <td >
                <@s.textfield name="resume.fare" cssClass="txtinput" maxLength="20" onkeyup="checkNum(this);" cssStyle="width:150px;"/>
           ...
           <tr>
             ...
             <td>
                 <@s.radio name="resume.info_state" list=r"#{'1':'正常','3':'禁用'}"  />    
                 <@s.fielderror><@s.param>resume.info_state</@s.param></@s.fielderror>	  	
             </td>  
             <td class="table_name">是否委托:</td>
             <td >
             	 <@s.radio name="resume.is_trust" list=r"#{'0':'否','1':'是'}"/>
             </td>
           </tr>
         </table>
	     <div class="buttom">
	       <@s.hidden name="token_value" value="${get_token_value?if_exists}"/>
	       <@s.hidden name="resume.resume_id" id="id"/>
	       <@s.hidden name="resume.cust_id"/>
	       <@s.hidden name="resume.user_id"/>
	       ${listSearchHiddenField?if_exists}
	      <@s.hidden name="resume.infoattr_id" />
           <#if sysmodule.is_catattr=="0">      
	       ...
	       <input type="button" name="sumit" value="重置" onclick="resetModify('/admin_Resume_view.action?resume.resume_id=');" />
	       <!--所属分类插件隐藏字段开始区域-->
