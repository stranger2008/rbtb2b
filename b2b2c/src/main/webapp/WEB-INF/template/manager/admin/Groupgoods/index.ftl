<html>
  ...
  <body>
<@s.form action="/admin_Groupgoods_list.action" method="post">
...
<div class="main_index f_left">
 ...
 <div class="main_top">
   <ul class="main_top_ul">
     <li class="tj"><a onclick="linkToInfo('/admin_Groupgoods_add.action','');">添加团购</a></li>
     <li class="sc"><a onclick="delInfo('groupgoods.group_id','/admin_Groupgoods_delete.action')">删除</a></li>
 ...
 <div class="main_cont">
  ...
  <tr style="background:url(images/top_tr.gif) repeat-x;">
    <td width="3%" class="top_td"><input type="checkbox" name="checkbox" id="checkall" onclick="selectAll('groupgoods.group_id')"/></td>
  ...
  <tr>
    ...
    <td align="center"><a onclick="linkToInfo('/admin_Groupgoods_view.action','groupgoods.group_id=${groupgoods.group_id?if_exists}');"><img src="/include/images/bj.gif" /></a></td>
  </tr>
  </#list>
</table>
 </div>
