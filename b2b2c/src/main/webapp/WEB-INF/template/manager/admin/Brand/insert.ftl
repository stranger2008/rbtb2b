...
<div class="tj_main f_left">
   ...
   <div class="tj_main_cont">
   	...
   	<@s.form action="/admin_Brand_insert.action" method="post" validate="true">
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">
           ...
           <tr>
             ...
             <td>
             	<#if sysmodule.is_catattr=="0">             
	                 ...
	                 <a href="/admin_Brand_cate.action?cat_attr=0">[重新选择]</a>
          ...
          <tr>
            ...
            <tr>
             ...
             <td>
                <@s.radio name="brand.is_recom" list=r"#{'0':'否','1':'是'}" value="0"/>
            ...
            <tr>
             ...
             <td>
             	<@s.radio name="brand.info_state" list=r"#{'0':'未审核','1':'审核通过','2':'审核未通过','3':'禁用'}" value="1"/>
            ...
            <tr>
             ...
             <td>
             	<@s.textfield name="brand.clicknum" size="12" onkeyup="checkNum(this);" maxLength="11" value="0" />
            ...
            <tr>
             ...
             <td>
             	<@s.textfield name="brand.fare" size="12" onkeyup="checkNum(this);" maxLength="11" value="0" />
