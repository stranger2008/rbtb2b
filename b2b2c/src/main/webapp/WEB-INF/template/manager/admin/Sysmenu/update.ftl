...
<div class="tj_main f_left">
 <div class="pageLocation">
 	当前位置:系统管理 > 系统设置 > 系统菜单管理 > 修改系统菜单
   </div>
   <div class="tj_main_cont">
   
   	<@s.form action="/admin_Sysmenu_update.action" method="post" validate="true">
        ...
        <table class="wwtable" cellspacing="1" cellpadding="8">
           ...
           <tr>
             ...
             <td>
             	<@s.select name="sysmenu.syscode" list=r"#{'sys':'管理员后台','com':'会员后台','b2c':'商城后台'}" headerValue="${sysmenu.syscode!sys}"/>
           ...
           <tr>
             ...
             <td>
             	<@s.radio name="sysmenu.enabled" list=r"#{'0':'有效','1':'无效'}" value="${sysmenu.enabled!0}"/>
