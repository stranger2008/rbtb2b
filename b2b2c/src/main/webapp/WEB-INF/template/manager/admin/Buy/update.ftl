...
<div class="tj_main f_left">
   <div class="pageLocation">
 	当前位置:功能模块 > 求购管理 > 求购列表 > 修改求购
   </div>
   <div class="tj_main_cont">
   	<@s.form action="/admin_Buy_update.action"  method="post" validate="true">
             ...
             <td>
                <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <@s.hidden name="buy.cat_attr" />
              		<a href="/admin_Buy_cate.action?cat_attr=0&buy.buy_id=${buy.buy_id?if_exists}">[重新选择]</a>
         ...
         <#if sysmodule.is_catattr=="0">      
          ...
          <tr>
           ...
           <tr>
             ...
             <td>
             	<@s.textfield  name="buy.clicknum" cssClass="txtinput" maxlength="11" onkeyup="checkNum(this);"/>
           ...
           <tr>
             ...
             <td>
             	<@s.textfield  name="buy.fare" cssClass="txtinput" maxlength="11" onkeyup="checkNum(this);"/>
           ...
           <tr>
             ...
             <td>
             	<@s.radio name="buy.info_state" list=r"#{'1':'正常','3':'禁用'}"  checked="true" />     
