<html>
  ...
  <body >
<@s.form action="/admin_Product_gopage.action"  method="post" validate="true"> 
...
<div class="main_index f_left">
 <div class="pageLocation">
	 ...
	 <div class="main_cont"  style="height:800px;">      
	   <table width="100%">
	      <tr><td><span style="font-size:14px;">请选择分类至最后一级:</span>&nbsp;&nbsp;<a href="admin_Category_list.action?type=product&ajaxRequestRandom=1" target="_blank">[分类管理]</a><@s.fielderror><@s.param>cate_attr</@s.param></@s.fielderror></td></tr>
          ...
          <#if product?if_exists!=''>
              <@s.hidden name="update_value" value="${product.product_id?if_exists}"/>   
	          <#if product.product_id?if_exists!="">
	             <@s.submit value="修改产品"  />
	          <#else>
	             <@s.submit value="添加产品"  />	
	          </#if>  
