...
<@s.form action="/admin_Job_auditList.action" method="post">
<div class="main_index f_left">
 <div class="pageLocation">
 	当前位置:功能模块 > 人才管理 > 招聘审核列表
   </div>
 <div class="main_top">
   <ul class="main_top_ul">
     
     <li class="shuaix"><a onclick="showSearch(this,'searchDiv');">筛选</a></li>
     <li class="sc"><a onclick="delInfo('job.job_id','/admin_Job_checkDel.action')">删除</a></li>
   </ul>
 </div>
 <div class="main_cont">
  ...
  <#list jobList as sysjob>
    ...
    <a onclick=linkToInfo("/admin_Job_audit.action","job.job_id=${sysjob.job_id?if_exists}");>
   ...
   <td align="center">
      <a onclick="linkToInfo('/admin_Job_auditList.action','cat_attr_s=${sysjob.cat_attr_id?if_exists}');">${sysjob.cat_attr?if_exists}</a>
   </td>
   <td align="center">${sysjob.area_attr?if_exists}</td>
   <td align="center" >
    <#if sysjob.info_state?if_exists='0'>
   <a href="/admin_Job_auditList.action?job_state_s=0" >
   <span class="redcolor">未审核</span>
   </a>
   <#elseif sysjob.info_state?if_exists='2'>
   <a href="/admin_Job_auditList.action?job_state_s=2" >
   <span class="bluecolor">未通过</span>
    ...
    <td align="center"><a onclick=linkToInfo("/admin_Job_audit.action","job.job_id=${sysjob.job_id?if_exists}");><img src="/include/images/audit.png" /></a></td>
  </tr>
...
<div class="divceng" style="display:none;" id="searchDiv">
	...
	<tr>
		...
		<td><@s.select name="job_state_s" list=r"#{'4':'请选择','0':'未审核','2':'未通过'}"  /> </td>
	</tr>
	<tr>
