...
<div class="tj_main f_left">
 <div class="pageLocation">
 	当前位置:功能模块 > 资讯管理 > 资讯列表 > 修改资讯
   </div>
   <div class="tj_main_cont">
   	<@s.form action="/admin_News_update.action"  method="post" validate="true">
       <table class="wwtable" cellspacing="1" cellpadding="8">
           <tr>
             ...
             <td colspan="3">
             	...
             	<input name="news.title_color" id="title_color" type="text" value="${news.title_color?if_exists}"  size="10"  class="iColorPicker" title="请选择标题颜色" />
             	<@s.fielderror><@s.param>news.title_color</@s.param></@s.fielderror>
             	 <@s.hidden  name="oldinfotitle" value="${news.title?if_exists}"/>
             </td>
           </tr>
           <tr>
          ...
          <tr>
             ...
             <td >
                <@s.checkboxlist name="news.news_attr" list=r"#{'h':'头条', 'c':'推荐', 'f':'幻灯','s':'滚动','b':'加粗'}" value="#request.attr" >
                </@s.checkboxlist>
             </td>
             ...
             <td >
              ...
              <#if sysmodule.is_catattr=="0">             
	                 ...
	                 <@s.hidden name="news.cat_attr" />
              		<a href="/admin_News_cate.action?cat_attr=0&news.news_id=${news.news_id?if_exists}">[重新选择]</a>
           ...
           <td class="table_name">文章来源:</td>
            ...
            <tr>
             ...
             <td >
                 ...
                 当前置顶至<@s.textfield id="sort_no" name="news.sort_no" cssClass="sort_no" style="border:none;" readonly="true"/>截止
             </td>
           </tr>
           <tr>
             ...
             <td >  
             	<@s.textfield name="news.fare" cssClass="txtinput" cssStyle="width:80px;" maxLength="20" onkeyup="checkNum(this);"/>
           ...
           <tr>
             ...
             <td >
             	<@s.textfield name="news.clicknum" cssClass="txtinput" maxLength="20"  cssStyle="width:150px;" onkeyup="checkNum(this);"/>
           ...
           <tr>
             ...
             <td  >
               <@s.radio name="news.comment" list=r"#{'0':'支持评论','1':'禁止评论'}" />    
               <@s.fielderror><@s.param>news.comment</@s.param></@s.fielderror>
             </td>
            ...
            <tr>
             ...
             <td colspan="3">
              <@s.radio name="news.info_state" list=r"#{'1':'正常','3':'禁用'}"    /> 
	     ...
	     <div class="buttom">
	       ...
	       <@s.hidden name="news.news_id" id="id"/>
	       <@s.hidden name="news.cust_id"/>
	       <@s.hidden name="news.user_id"/>
	       
			${listSearchHiddenField?if_exists}


	        <@s.hidden name="news.infoattr_id" />
           <#if sysmodule.is_catattr=="0">      
