...
<@s.form action="/admin_Buy_list.action" method="post">
<@s.hidden name="buy.is_recom" id="admin_buy_state"/>
<div class="main_index f_left">
 ...
 <div class="main_top">
   ...
   <ul class="main_top_ul">
     <li class="tj"><a  href="###"  onclick="linkToInfo('/admin_Buy_cate.action','')">添加求购</a></li>   
     <li class="shuaix"><a onclick="showSearch(this,'searchDiv');">筛选</a></li>
     <li class="sc"><a onclick="delInfo('buy.buy_id','/admin_Buy_delete.action')">删除</a></li>
     <li class="qiyong"><a onclick="updateRecomState('1','buy.buy_id','/admin_Buy_updateisrecom.action','admin_buy_state');">推荐</a></li>
     <li class="jingyong"><a onclick="updateRecomState('0','buy.buy_id','/admin_Buy_updateisrecom.action','admin_buy_state');">取消推荐</a></li>
   </ul>
 ...
 <div class="main_cont">
  ...
  <#list buyList as buy>
    ...
    <#if buy.title?if_exists!=''>
	    <a  onclick="linkToInfo('/admin_Buy_view.action','buy.buy_id=${buy.buy_id?if_exists}');">
	    ...
	    <#if buy.is_recom='1'>
			<a  onclick="linkToInfo('/admin_Buy_list.action','is_recom_s=${buy.is_recom?if_exists}')"><font class="redcolor">[推荐]</font>
		</#if>
    </#if>
    </td> 
    <td align="center">
    <a href="/admin_Member_viewinfo.action?member.cust_id=${(buy.cust_id)?if_exists}" target="_blank"> 
        ${buy.cust_name?if_exists}
    </a>
    </td>
    <td align="center"><a  href="###"  onclick="linkToInfo('/admin_Buy_list.action','type_s=${buy.buy_type?if_exists}')">${buy.model_value?if_exists}</a></td>
    <td align="center">
     	<a onclick="linkToInfo('/admin_Buy_list.action','cat_attr_s=${buy.cat_attr_id?if_exists}');">${buy.cat_attr?if_exists}</a>
    </td>
    <td align="center">${buy.area_attr?if_exists}</td>
    <td align="center">
	    <a  onclick="linkToInfo('/admin_Buy_list.action','state_s=${buy.info_state?if_exists}')">
    ...
    <td align="center"><a onclick="linkToInfo('/admin_Buy_view.action','buy.buy_id=${buy.buy_id?if_exists}');"><img src="/include/images/bj.gif" /></a></td>
  </tr>
</#list> 
</table>
 </div>
