<html>
  ...
  <body>
<@s.form action="/admin_Goods_list.action" method="post">
...
<div class="main_index f_left">
 ...
 <div class="main_top">
   <ul class="main_top_ul">
     <li class="tj"><a onclick="linkToInfo('/admin_Goods_add.action','');">添加商品</a></li>
 ...
 <div class="main_cont">
  ...
  <tr style="background:url(images/top_tr.gif) repeat-x;">
    <td width="3%" class="top_td"><input type="checkbox" name="checkbox" id="checkall" onclick="selectAll('goods.goods_id')"/></td>
         <td width="20%"  align="center" class="top_td">商品名称</td>
     	 <td width="13%"  align="center" class="top_td">会员名称</td>
     	 <td width="20%"  align="center" class="top_td">所属分类</td>
     	 <td width="12%"  align="center" class="top_td">商品编号</td>
     	 <td width="8%"  align="center" class="top_td">商品品牌</td>
     	 <td width="8%"  align="center" class="top_td">销售价</td>
     	 <td width="5%"  align="center" class="top_td">免运费</td>
  ...
  <tr style="line-height:26px;">
    <td><input type="checkbox" name="goods.goods_id" value="${goods.goods_id?if_exists}"/></td>    
        <td align="left">
	    	<#if goods.goods_name?if_exists!=''>
				<a onclick="linkToInfo('/admin_Goods_view.action','goods.goods_id=${goods.goods_id?if_exists}');">
				    <#if goods.goods_name?length lt 20>
				    ${goods.goods_name?if_exists}
				    <#else>
				    ${goods.goods_name[0..18]}...
				    </#if>
			    </a>
		    </#if>
    	</td>
