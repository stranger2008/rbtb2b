...
<!--导航结束-->
<div class="position"><p>您当前的位置：<a href="/groupgoods.html">团购</a> > <a href="/mall/goods!noticeGroup.action">团购公告栏</a></p></div>
<div class="w980"> 
  ...
  <div class="noticeR">
    <div class="noticeL">
      <div class="noticescont">
		 <ul>
         <#list newsIndexList as news> 
		             <li><a href="/mall/goods!noticeDetail.action?nid=${news.news_id?if_exists}">				        
