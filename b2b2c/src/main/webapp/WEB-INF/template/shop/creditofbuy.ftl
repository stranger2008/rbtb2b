...
<body>
<@s.form action="/shop/${user_name?if_exists}/shopcreditofbuy.html" method="post">
...
<div class="w980">
   <div class="discusslist">
     ...
     <div class="discont" >
     <#if sellergoodsevalList?if_exists && (sellergoodsevalList?size > 0)>
         <table width="100%" cellpadding="0" cellspacing="0" class="distable">
         <tr><th width="10%"></th>
         <th width="30%"></th><th width="20%">评价人</th><th width="40%">宝贝信息</th></tr>
        
        <#list sellergoodsevalList  as sellerlist>
         <tr>
	         <td width="5%">
	         	 <#if sellerlist.g_eval=="1">
	         	<img src="/templets/shop/images/xzhp_07.gif">
	         	<#elseif sellerlist.g_eval=="0">
	         	<img src="/templets/shop/images/xzzp_07.gif">
	         	<#elseif sellerlist.g_eval=="-1">
	         	<img src="/templets/shop/images/xzcp_07.gif">
	         	</#if>
	         </td>
	         <td width="35%">
	         	${(sellerlist.g_comment)?if_exists}<p>[${(sellerlist.evalcom_data)?if_exists}]</p>
	         </td>
	         <td width="20%">
	         	买家 ：<a href="#" class="blue">${(sellerlist.user_name)?if_exists}</a>
	         </td>
	         <td width="40%">
	         	<a href="/mall-goodsdetail-${sellerlist.goods_id?if_exists}.html" target="_blank" class="blue">${(sellerlist.goods_name)?if_exists}</a><p class="orange">${(sellerlist.sale_price)?if_exists}元</p>
	         </td>
        </tr>
		</#list>
         </table>
