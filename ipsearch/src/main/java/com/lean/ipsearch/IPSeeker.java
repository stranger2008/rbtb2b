...
public class IPSeeker
{
    ...
    private IPSeeker()
    {
        ...
        try
        {
            InputStream ipFileStream = IPSeeker.class.getResourceAsStream("/qqwry.dat");
    ...
    public static RandomAccessFile toRandomAccessFile(InputStream is)
            throws IOException
    {
    ...
    {
        if (this.ipFile == null) return "错误的IP数据库文件";
